...
})}))},enumerable:!0,configurable:!0}),Book}();ReVIEW.Book=Book;var Part=function(){function Part(parent,no,name){this.parent=parent,this.no=no,this.name=name}return Part}();ReVIEW.Part=Part;var Chapter=function(){function Chapter(parent,no,name,input,root){this.parent=parent,this.no=no,this.name=name,this.input=input,this.root=root,this.builderProcesses=[],this.process=new Process(this.parent,this,input)}return Chapter.prototype.createBuilderProcess=function(builder){var builderProcess=new BuilderProcess(builder,this.process);return this.builderProcesses.push(builderProcess),builderProcess},Chapter.prototype.findResultByBuilder=function(builder){var founds;return founds="string"==typeof builder?this.builderProcesses.filter(function(process){return process.builder.name===builder}):this.builderProcesses.filter(function(process){return process.builder===builder}),founds[0].result},Chapter}();ReVIEW.Chapter=Chapter}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){var t=ReVIEW.i18n.t,SyntaxTree=ReVIEW.Parse.SyntaxTree;ReVIEW.Parse.HeadlineSyntaxTree,ReVIEW.Parse.BlockElementSyntaxTree,ReVIEW.Parse.InlineElementSyntaxTree,ReVIEW.Parse.TextNodeSyntaxTree,ReVIEW.Parse.ChapterSyntaxTree;var flatten=ReVIEW.flatten,Controller=function(){function Controller(options){"undefined"==typeof options&&(options={}),this.options=options}return Controller.prototype.initConfig=function(data){this.config=data,data.analyzer=data.analyzer||new ReVIEW.Build.DefaultAnalyzer,data.validators&&0!==data.validators.length?Array.isArray(data.validators)||(this.config.validators=[data.validators]):this.config.validators=[new ReVIEW.Build.DefaultValidator],data.builders&&0!==data.builders.length?Array.isArray(data.builders)||(this.config.builders=[data.builders]):this.config.builders=[new ReVIEW.Build.DefaultBuilder]},Controller.prototype.process=function(){var _this=this,acceptableSyntaxes=this.config.analyzer.getAcceptableSyntaxes();if(this.config.listener&&this.config.listener.onAcceptables&&this.config.listener.onAcceptables(acceptableSyntaxes)===!1)return null;var book=this.processBook();if(this.config.validators.forEach(function(validator){validator.start(book,acceptableSyntaxes,_this.config.builders)}),book.reports.some(function(report){return report.level===ReVIEW.ReportLevel.Error}))return this.outputReport(book.reports),book;if(this.config.listener&&this.config.listener.onSymbols){var symbols=flatten(book.parts.map(function(part){return part.chapters.map(function(chapter){return chapter.process.symbols})}));if(this.config.listener.onSymbols(symbols)===!1)return null}return this.config.builders.forEach(function(builder){builder.init(book)}),this.outputReport(book.reports),this.compileFinished(book),book},Controller.prototype.processBook=function(){var _this=this,book=new ReVIEW.Book(this.config);return book.parts=Object.keys(this.config.book).map(function(key,index){var chapters=_this.config.book[key];return _this.processPart(book,index,key,chapters)}),book.parts.forEach(function(part){var chapters=[];part.chapters.forEach(function(chapter){ReVIEW.visit(chapter.root,{visitDefaultPre:function(){},visitChapterPre:function(node){chapters.push(node)}})});var counter={},max=0,currentLevel=0;chapters.forEach(function(chapter){var level=chapter.headline.level;if(max=Math.max(max,level),currentLevel>level)for(var i=level+1;max>=i;i++)counter[i]=0;else if(level>currentLevel)for(var i=level;max>=i;i++)counter[i]=0;currentLevel=level,counter[level]+=1,chapter.no=counter[level]})}),book},Controller.prototype.processPart=function(book,index,name,chapters){"undefined"==typeof chapters&&(chapters=[]);var _this=this,part=new ReVIEW.Part(book,index+1,name);return part.chapters=chapters.map(function(chapter,index){return _this.processChapter(book,part,index,chapter)}),part},Controller.prototype.processChapter=function(book,part,index,chapterPath){var resolvedPath=this.resolvePath(chapterPath),data=this.read(resolvedPath);if(!data){var chapter=new ReVIEW.Chapter(part,index+1,chapterPath,data,null);return chapter.process.error(t("compile.file_not_exists",resolvedPath)),chapter}try{var parseResult=ReVIEW.Parse.parse(data),chapter=new ReVIEW.Chapter(part,index+1,chapterPath,data,parseResult.ast)}catch(e){if(!(e instanceof PEG.SyntaxError))throw e;var se=e,errorNode=new SyntaxTree({syntax:se.name,line:se.line,column:se.column,offset:se.offset,endPos:-1}),chapter=new ReVIEW.Chapter(part,index+1,chapterPath,data,null);chapter.process.error(se.message,errorNode)}return chapter},Object.defineProperty(Controller.prototype,"read",{get:function(){return this.config.read||ReVIEW.IO.read},enumerable:!0,configurable:!0}),Object.defineProperty(Controller.prototype,"write",{get:function(){return this.config.write||ReVIEW.IO.write},enumerable:!0,configurable:!0}),Object.defineProperty(Controller.prototype,"outputReport",{get:function(){return this.config.listener&&this.config.listener.onReports?this.config.listener.onReports:ReVIEW.isNodeJS()?this.outputReportNodeJS:this.outputReportBrowser},enumerable:!0,configurable:!0}),Controller.prototype.outputReportNodeJS=function(reports){var colors=require("colors");colors.setTheme({info:"cyan",warn:"yellow",error:"red"}),reports.forEach(function(report){var message="";if(message+=report.chapter.name+" ",report.nodes.forEach(function(node){message+="["+node.line+","+node.column+"] "}),message+=report.message,report.level===ReVIEW.ReportLevel.Error)console.warn(message.error);else if(report.level===ReVIEW.ReportLevel.Warning)console.error(message.warn);else{if(report.level!==ReVIEW.ReportLevel.Info)throw new Error("unknown report level.");console.info(message.info)}})},Controller.prototype.outputReportBrowser=function(reports){reports.forEach(function(report){var message="";if(message+=report.chapter.name+" ",report.nodes.forEach(function(node){message+="["+node.line+","+node.column+"] "}),message+=report.message,report.level===ReVIEW.ReportLevel.Error)console.warn(message);else if(report.level===ReVIEW.ReportLevel.Warning)console.error(message);else{if(report.level!==ReVIEW.ReportLevel.Info)throw new Error("unknown report level.");console.info(message)}})},Controller.prototype.compileFinished=function(book){var func=function(){};book.reports.some(function(report){return report.level===ReVIEW.ReportLevel.Error})?this.config.listener&&this.config.listener.onCompileFailed?func=this.config.listener.onCompileFailed:ReVIEW.isNodeJS()&&(func=function(){process.exit(1)}):this.config.listener&&this.config.listener.onCompileSuccess?func=this.config.listener.onCompileSuccess:ReVIEW.isNodeJS()&&(func=function(){process.exit(0)}),func(book)},Controller.prototype.resolvePath=function(path){if(ReVIEW.isNodeJS()){var p=require("path"),base=this.options.base||"./";return p.join(base,path)}return this.options.base?(this.endWith(base,"/")||this.startWith(path,"/")||(base+="/"),base+path):path},Controller.prototype.startWith=function(str,target){return 0===str.indexOf(target)},Controller.prototype.endWith=function(str,target){return-1!==str.indexOf(target,str.length-target.length)},Controller}();ReVIEW.Controller=Controller}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){!function(Build){var t=ReVIEW.i18n.t;ReVIEW.Parse.SyntaxTree,ReVIEW.Parse.ChapterSyntaxTree,ReVIEW.Parse.HeadlineSyntaxTree,ReVIEW.Parse.BlockElementSyntaxTree,ReVIEW.Parse.InlineElementSyntaxTree;var DefaultValidator=function(){function DefaultValidator(){}return DefaultValidator.prototype.start=function(book,acceptableSyntaxes,builders){this.acceptableSyntaxes=acceptableSyntaxes,this.builders=builders,this.checkBook(book),this.resolveSymbolAndReference(book)},DefaultValidator.prototype.checkBook=function(book){var _this=this;book.parts.forEach(function(part){return _this.checkPart(part)})},DefaultValidator.prototype.checkPart=function(part){var _this=this;part.chapters.forEach(function(chapter){return _this.checkChapter(chapter)})},DefaultValidator.prototype.checkChapter=function(chapter){var _this=this;ReVIEW.visit(chapter.root,{visitDefaultPre:function(){},visitHeadlinePre:function(node){var results=_this.acceptableSyntaxes.find(node);return 1!==results.length?(chapter.process.error(t("compile.syntax_definietion_error"),node),void 0):results[0].process(chapter.process,node)},visitBlockElementPre:function(node){var results=_this.acceptableSyntaxes.find(node);if(1!==results.length)return chapter.process.error(t("compile.syntax_definietion_error"),node),void 0;var expects=results[0].argsLength,arg=node.args||[];if(-1===expects.indexOf(arg.length)){var expected=expects.map(function(n){return Number(n).toString()}).join(" or "),message=t("compile.args_length_mismatch",expected,arg.length);return chapter.process.error(message,node),void 0}return results[0].process(chapter.process,node)},visitInlineElementPre:function(node){var results=_this.acceptableSyntaxes.find(node);return 1!==results.length?(chapter.process.error(t("compile.syntax_definietion_error"),node),void 0):results[0].process(chapter.process,node)}}),ReVIEW.visit(chapter.root,{visitDefaultPre:function(){},visitChapterPre:function(node){if(1===node.level)ReVIEW.findChapter(node)||chapter.process.error(t("compile.chapter_not_toplevel"),node);else{var parent=ReVIEW.findChapter(node.parentNode);parent?parent.level!==node.level-1&&chapter.process.error(t("compile.chapter_level_omission",node.level,node.level-1,parent?String(parent.level):"none"),node):chapter.process.error(t("compile.chapter_topleve_eq1"),node)}}})},DefaultValidator.prototype.resolveSymbolAndReference=function(book){var symbols=ReVIEW.flatten(book.parts.map(function(part){return part.chapters.map(function(chapter){return chapter.process.symbols})}));symbols.forEach(function(symbol){var referenceTo=symbol.referenceTo;if(referenceTo)return referenceTo.part||book.parts.forEach(function(part){referenceTo.partName===part.name&&(referenceTo.part=part)}),referenceTo.part?(referenceTo.chapter||referenceTo.part.chapters.forEach(function(chap){referenceTo.chapterName===chap.name&&(referenceTo.chapter=chap)}),referenceTo.chapter?void 0:(symbol.chapter.process.error(t("compile.chapter_is_missing",symbol.chapter.name),symbol.node),void 0)):(symbol.chapter.process.error(t("compile.part_is_missing",symbol.part.name),symbol.node),void 0)}),symbols.forEach(function(symbol){if(symbol.referenceTo&&!symbol.referenceTo.referenceNode){var reference=symbol.referenceTo;if(symbols.forEach(function(symbol){reference.part===symbol.part&&reference.chapter===symbol.chapter&&reference.targetSymbol===symbol.symbolName&&reference.label===symbol.labelName&&(reference.referenceNode=symbol.node)}),!reference.referenceNode)return symbol.chapter.process.error(t("compile.reference_is_missing",reference.targetSymbol,reference.label),symbol.node),void 0}}),symbols.forEach(function(symbol1){symbols.forEach(function(symbol2){return symbol1!==symbol2?symbol1.chapter===symbol2.chapter&&symbol1.symbolName===symbol2.symbolName&&symbol1.labelName&&symbol2.labelName&&symbol1.labelName===symbol2.labelName?(symbol1.chapter.process.error(t("compile.duplicated_label"),symbol1.node,symbol2.node),void 0):void 0:void 0})})},DefaultValidator}();Build.DefaultValidator=DefaultValidator}(ReVIEW.Build||(ReVIEW.Build={})),ReVIEW.Build}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){!function(Build){var i18n=ReVIEW.i18n;ReVIEW.Parse.SyntaxTree,ReVIEW.Parse.NodeSyntaxTree,ReVIEW.Parse.BlockElementSyntaxTree,ReVIEW.Parse.InlineElementSyntaxTree,ReVIEW.Parse.HeadlineSyntaxTree,ReVIEW.Parse.UlistElementSyntaxTree,ReVIEW.Parse.TextNodeSyntaxTree,ReVIEW.Parse.ChapterSyntaxTree;var nodeContentToString=ReVIEW.nodeContentToString,findChapter=ReVIEW.findChapter,TextBuilder=function(_super){function TextBuilder(){_super.apply(this,arguments)}return __extends(TextBuilder,_super),TextBuilder.prototype.chapterPost=function(process,node){node.headline.cmd?process.out("◆→終了:←◆\n"):process.out("\n")},TextBuilder.prototype.headlinePre=function(process,name,node){if(node.cmd)return process.out("◆→開始:←◆\n"),process.out("■"),function(v){ReVIEW.visit(node.caption,v)};if(process.out("■H").out(node.level).out("■"),1===node.level){var text=i18n.t("builder.chapter",node.parentNode.no);process.out(text).out("　")}else 2===node.level&&process.out(node.parentNode.toChapter().fqn).out("　")},TextBuilder.prototype.headlinePost=function(process){process.out("\n\n")},TextBuilder.prototype.ulistPre=function(process,name,node){return process.out("・"),function(v){ReVIEW.visit(node.text,v),process.out("\n"),node.childNodes.forEach(function(child){process.out(ReVIEW.stringRepeat(child.toUlist().level-1,"    ")),ReVIEW.visit(child,v)})}},TextBuilder.prototype.ulistPost=function(){},TextBuilder.prototype.block_list_pre=function(process,node){process.out("◆→開始:リスト←◆\n");var chapter=findChapter(node,1),text=i18n.t("builder.list",chapter.fqn,node.no);return process.out(text).out("　").out(node.args[1].arg).out("\n\n"),function(v){node.childNodes.forEach(function(node){ReVIEW.visit(node,v)})}},TextBuilder.prototype.block_list_post=function(process){process.out("◆→終了:リスト←◆\n")},TextBuilder.prototype.inline_list=function(process,node){var chapter=findChapter(node,1),listNode=this.findReference(process,node).referenceTo.referenceNode.toBlockElement(),text=i18n.t("builder.list",chapter.fqn,listNode.no);return process.out(text),!1},TextBuilder.prototype.inline_hd_pre=function(process,node){process.out("「");var chapter=findChapter(node);return 1===chapter.level?process.out(chapter.fqn).out("章 "):process.out(chapter.fqn).out(" "),process.out(nodeContentToString(process,chapter.headline)),!1},TextBuilder.prototype.inline_hd_post=function(process){process.out("」")},TextBuilder.prototype.inline_br=function(process){process.out("\n")},TextBuilder.prototype.inline_b_pre=function(process){process.out("★")},TextBuilder.prototype.inline_b_post=function(process){process.out("☆")},TextBuilder.prototype.inline_code_pre=function(process){process.out("△")},TextBuilder.prototype.inline_code_post=function(process){process.out("☆")},TextBuilder.prototype.inline_href_pre=function(process){process.out("△")},TextBuilder.prototype.inline_href_post=function(process){process.out("☆")},TextBuilder.prototype.inline_kw=function(process){process.out("[p]")},TextBuilder}(Build.DefaultBuilder);Build.TextBuilder=TextBuilder}(ReVIEW.Build||(ReVIEW.Build={})),ReVIEW.Build}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){!function(Build){var i18n=ReVIEW.i18n;ReVIEW.Parse.SyntaxTree,ReVIEW.Parse.NodeSyntaxTree;var BlockElementSyntaxTree=ReVIEW.Parse.BlockElementSyntaxTree;ReVIEW.Parse.InlineElementSyntaxTree;var HeadlineSyntaxTree=ReVIEW.Parse.HeadlineSyntaxTree;ReVIEW.Parse.UlistElementSyntaxTree,ReVIEW.Parse.TextNodeSyntaxTree,ReVIEW.Parse.ChapterSyntaxTree;var nodeContentToString=ReVIEW.nodeContentToString,findChapter=ReVIEW.findChapter,HtmlBuilder=function(_super){function HtmlBuilder(standalone){"undefined"==typeof standalone&&(standalone=!0),_super.call(this),this.standalone=standalone}return __extends(HtmlBuilder,_super),HtmlBuilder.prototype.processPost=function(process,chapter){if(this.standalone){var pre="";pre+='<?xml version="1.0" encoding="UTF-8"?>\n',pre+='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">\n',pre+='<html xmlns="http://www.w3.org/1999/xhtml" xmlns:ops="http://www.idpf.org/2007/ops" xml:lang="ja">\n',pre+="<head>\n",pre+='  <meta http-equiv="Content-Type" content="text/html;charset=UTF-8" />\n',pre+='  <meta http-equiv="Content-Style-Type" content="text/css" />\n',pre+='  <meta name="generator" content="ReVIEW" />\n';var name=null;ReVIEW.visit(chapter.root,{visitDefaultPre:function(){},visitChapterPre:function(node){name=nodeContentToString(process,node.headline.caption)}}),pre+="  <title>"+name+"</title>\n",pre+="</head>\n",pre+="<body>\n",process.pushOut(pre),process.out("</body>\n"),process.out("</html>\n")}},HtmlBuilder.prototype.text=function(process,node){var plane=!1;ReVIEW.walk(node,function(node){if(!node.parentNode)return null;if(node instanceof BlockElementSyntaxTree){var block=node.toBlockElement();if("list"===block.symbol)return plane=!0,null}else if(node instanceof HeadlineSyntaxTree)return plane=!0,null;return node.parentNode}),plane?process.out(node.text):(process.out("<p>"),process.out(node.text),process.out("</p>\n"))},HtmlBuilder.prototype.headlinePre=function(process,name,node){if(node.cmd&&process.out('<div class="column">\n'),process.out("<h").out(node.level),node.label&&process.out(' id="').out(node.label.arg).out('"'),process.out(">"),node.cmd?process.out('<a id="column-').out(node.parentNode.no).out('"></a>'):process.out('<a id="h').out(node.level).out('"></a>'),node.cmd)return function(v){ReVIEW.visit(node.caption,v)};if(1===node.level){var text=i18n.t("builder.chapter",node.parentNode.no);process.out(text).out("　")}else 2===node.level&&process.out(node.parentNode.toChapter().fqn).out("　")},HtmlBuilder.prototype.headlinePost=function(process,name,node){process.out("</h").out(node.level).out(">\n"),node.cmd&&process.out("</div>\n")},HtmlBuilder.prototype.ulistPre=function(process,name,node){return process.out("<li>"),node.childNodes.length>0?function(v){ReVIEW.visit(node.text,v),process.out("<ul>"),node.childNodes.forEach(function(child){ReVIEW.visit(child,v)}),process.out("</ul>")}:void 0},HtmlBuilder.prototype.ulistPost=function(process){process.out("</li>")},HtmlBuilder.prototype.block_list_pre=function(process,node){process.out('<div class="caption-code">\n');var chapter=findChapter(node,1),text=i18n.t("builder.list",chapter.fqn,node.no);return process.out('<p class="caption">').out(text).out(": ").out(node.args[1].arg).out("</p>\n"),process.out('<pre class="list">'),function(v){node.childNodes.forEach(function(node){ReVIEW.visit(node,v)})}},HtmlBuilder.prototype.block_list_post=function(process){process.out("</pre>\n").out("</div>\n")},HtmlBuilder.prototype.inline_list=function(process,node){var chapter=findChapter(node,1),listNode=this.findReference(process,node).referenceTo.referenceNode.toBlockElement(),text=i18n.t("builder.list",chapter.fqn,listNode.no);return process.out(text),!1},HtmlBuilder.prototype.inline_hd_pre=function(process,node){process.out("「");var chapter=findChapter(node);return 1===chapter.level?process.out(chapter.fqn).out("章 "):process.out(chapter.fqn).out(" "),process.out(nodeContentToString(process,chapter.headline)),!1},HtmlBuilder.prototype.inline_hd_post=function(process){process.out("」")},HtmlBuilder.prototype.inline_br=function(process){process.out("<br/>")},HtmlBuilder.prototype.inline_b_pre=function(process){process.out("<b>")},HtmlBuilder.prototype.inline_b_post=function(process){process.out("</b>")},HtmlBuilder.prototype.inline_code_pre=function(process){process.out("<tt class='inline-code'>")},HtmlBuilder.prototype.inline_code_post=function(process){process.out("</tt>")},HtmlBuilder.prototype.inline_href_pre=function(process,node){var href=nodeContentToString(process,node);process.out('<a href="'+href+'">')},HtmlBuilder.prototype.inline_href_post=function(process){process.out("</a>")},HtmlBuilder.prototype.inline_kw_pre=function(process,node){return process.out("<b>"),process.out(ReVIEW.nodeToString(process,node)),!1},HtmlBuilder.prototype.inline_kw_post=function(process){process.out("</b>")},HtmlBuilder}(Build.DefaultBuilder);Build.HtmlBuilder=HtmlBuilder}(ReVIEW.Build||(ReVIEW.Build={})),ReVIEW.Build}(ReVIEW||(ReVIEW={}));var ReVIEW;if(function(ReVIEW){function start(setup,options){var controller=new ReVIEW.Controller(options);return setup(controller),controller.process()}ReVIEW.start=start}(ReVIEW||(ReVIEW={})),ReVIEW.isNodeJS()&&(module.exports=ReVIEW),ReVIEW.isNodeJS()){var program=require("commander");program.version("TODO","-v, --version").option("--reviewfile <file>","where is ReVIEWconfig.js?").option("--base <path>","alternative base path"),program.command("compile <document>").description("compile ReVIEW document").option("--ast","output JSON format abstract syntax tree").option("-t, --target <target>","output format of document").action(function(document,options){options.ast||!1}),program.command("*").action(function(){var reviewfile=program.reviewfile||"./ReVIEWconfig",setup=require(reviewfile);ReVIEW.start(setup,{reviewfile:reviewfile,base:program.base})});var endWith=function(str,target){return-1!==str.indexOf(target,str.length-target.length)};endWith(process.argv[1],"review.js")&&program.parse(process.argv)}
>>>>>>> bols-blue
=======
}function peg$parseInlineElementContents(){var s0,s1,s2,s3,key=38*peg$currPos+16,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,s0=peg$currPos,s1=peg$currPos,peg$silentFails++,125===input.charCodeAt(peg$currPos)?(s2=peg$c42,peg$currPos++):(s2=null,0===peg$silentFails&&peg$fail(peg$c43)),peg$silentFails--,null===s2?s1=peg$c2:(peg$currPos=s1,s1=peg$c1),null!==s1?(s2=peg$parseInlineElementContent(),null!==s2?(s3=peg$parseInlineElementContents(),null===s3&&(s3=peg$c2),null!==s3?(peg$reportedPos=s0,s1=peg$c64(s2,s3),null===s1?(peg$currPos=s0,s0=s1):s0=s1):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c63)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parseInlineElementContent(){var s0,s1,key=38*peg$currPos+17,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,s0=peg$currPos,s1=peg$parseInlineElement(),null!==s1&&(peg$reportedPos=s0,s1=peg$c66(s1)),null===s1?(peg$currPos=s0,s0=s1):s0=s1,null===s0&&(s0=peg$currPos,s1=peg$parseInlineElementContentText(),null!==s1&&(peg$reportedPos=s0,s1=peg$c66(s1)),null===s1?(peg$currPos=s0,s0=s1):s0=s1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c65)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parseInlineElementContentText(){var s0,s1,s2,s3,s4,s5,key=38*peg$currPos+18,cached=peg$cache[key];if(cached)return peg$currPos=cached.nextPos,cached.result;if(peg$silentFails++,s0=peg$currPos,s1=peg$currPos,s2=[],s3=peg$currPos,s4=peg$currPos,peg$silentFails++,s5=peg$parseInlineElement(),peg$silentFails--,null===s5?s4=peg$c2:(peg$currPos=s4,s4=peg$c1),null!==s4?(peg$c68.test(input.charAt(peg$currPos))?(s5=input.charAt(peg$currPos),peg$currPos++):(s5=null,0===peg$silentFails&&peg$fail(peg$c69)),null!==s5?(s4=[s4,s5],s3=s4):(peg$currPos=s3,s3=peg$c1)):(peg$currPos=s3,s3=peg$c1),null!==s3)for(;null!==s3;)s2.push(s3),s3=peg$currPos,s4=peg$currPos,peg$silentFails++,s5=peg$parseInlineElement(),peg$silentFails--,null===s5?s4=peg$c2:(peg$currPos=s4,s4=peg$c1),null!==s4?(peg$c68.test(input.charAt(peg$currPos))?(s5=input.charAt(peg$currPos),peg$currPos++):(s5=null,0===peg$silentFails&&peg$fail(peg$c69)),null!==s5?(s4=[s4,s5],s3=s4):(peg$currPos=s3,s3=peg$c1)):(peg$currPos=s3,s3=peg$c1);else s2=peg$c1;return null!==s2&&(s2=input.substring(s1,peg$currPos)),s1=s2,null!==s1&&(peg$reportedPos=s0,s1=peg$c70(s1)),null===s1?(peg$currPos=s0,s0=s1):s0=s1,peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c67)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0}function peg$parseSinglelineContent(){var s0,s1,s2,key=38*peg$currPos+19,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,s0=peg$currPos,s1=peg$parseContentInlines(),null!==s1?(s2=peg$parseNewline(),null===s2&&(s2=peg$parseEOF()),null!==s2?(peg$reportedPos=s0,s1=peg$c72(s1),null===s1?(peg$currPos=s0,s0=s1):s0=s1):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c71)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parseContentInlines(){var s0,s1,s2,key=38*peg$currPos+20,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,s0=peg$currPos,s1=peg$parseContentInline(),null!==s1?(s2=peg$parseContentInlines(),null===s2&&(s2=peg$c2),null!==s2?(peg$reportedPos=s0,s1=peg$c74(s1,s2),null===s1?(peg$currPos=s0,s0=s1):s0=s1):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c73)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parseContentInline(){var s0,s1,key=38*peg$currPos+21,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,s0=peg$currPos,s1=peg$parseInlineElement(),null!==s1&&(peg$reportedPos=s0,s1=peg$c76(s1)),null===s1?(peg$currPos=s0,s0=s1):s0=s1,null===s0&&(s0=peg$currPos,s1=peg$parseContentInlineText(),null!==s1&&(peg$reportedPos=s0,s1=peg$c76(s1)),null===s1?(peg$currPos=s0,s0=s1):s0=s1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c75)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parseContentInlineText(){var s0,s1,s2,s3,s4,s5,key=38*peg$currPos+22,cached=peg$cache[key];if(cached)return peg$currPos=cached.nextPos,cached.result;if(peg$silentFails++,s0=peg$currPos,s1=peg$currPos,s2=[],s3=peg$currPos,s4=peg$currPos,peg$silentFails++,s5=peg$parseInlineElement(),peg$silentFails--,null===s5?s4=peg$c2:(peg$currPos=s4,s4=peg$c1),null!==s4?(peg$c23.test(input.charAt(peg$currPos))?(s5=input.charAt(peg$currPos),peg$currPos++):(s5=null,0===peg$silentFails&&peg$fail(peg$c24)),null!==s5?(s4=[s4,s5],s3=s4):(peg$currPos=s3,s3=peg$c1)):(peg$currPos=s3,s3=peg$c1),null!==s3)for(;null!==s3;)s2.push(s3),s3=peg$currPos,s4=peg$currPos,peg$silentFails++,s5=peg$parseInlineElement(),peg$silentFails--,null===s5?s4=peg$c2:(peg$currPos=s4,s4=peg$c1),null!==s4?(peg$c23.test(input.charAt(peg$currPos))?(s5=input.charAt(peg$currPos),peg$currPos++):(s5=null,0===peg$silentFails&&peg$fail(peg$c24)),null!==s5?(s4=[s4,s5],s3=s4):(peg$currPos=s3,s3=peg$c1)):(peg$currPos=s3,s3=peg$c1);else s2=peg$c1;return null!==s2&&(s2=input.substring(s1,peg$currPos)),s1=s2,null!==s1&&(peg$reportedPos=s0,s1=peg$c78(s1)),null===s1?(peg$currPos=s0,s0=s1):s0=s1,peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c77)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0}function peg$parseUlist(){var s0,s1,s2,key=38*peg$currPos+23,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,s0=peg$currPos,s1=peg$parseUlistElement(),null===s1&&(s1=peg$parseSinglelineComment()),null!==s1?(s2=peg$parseUlist(),null===s2&&(s2=peg$c2),null!==s2?(peg$reportedPos=s0,s1=peg$c80(s1,s2),null===s1?(peg$currPos=s0,s0=s1):s0=s1):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c79)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parseUlistElement(){var s0,s1,s2,s3,s4,key=38*peg$currPos+24,cached=peg$cache[key];if(cached)return peg$currPos=cached.nextPos,cached.result;if(peg$silentFails++,s0=peg$currPos,s1=[],32===input.charCodeAt(peg$currPos)?(s2=peg$c82,peg$currPos++):(s2=null,0===peg$silentFails&&peg$fail(peg$c83)),null!==s2)for(;null!==s2;)s1.push(s2),32===input.charCodeAt(peg$currPos)?(s2=peg$c82,peg$currPos++):(s2=null,0===peg$silentFails&&peg$fail(peg$c83));else s1=peg$c1;if(null!==s1){if(s2=[],42===input.charCodeAt(peg$currPos)?(s3=peg$c84,peg$currPos++):(s3=null,0===peg$silentFails&&peg$fail(peg$c85)),null!==s3)for(;null!==s3;)s2.push(s3),42===input.charCodeAt(peg$currPos)?(s3=peg$c84,peg$currPos++):(s3=null,0===peg$silentFails&&peg$fail(peg$c85));else s2=peg$c1;null!==s2?(s3=peg$parse_(),null!==s3?(s4=peg$parseSinglelineContent(),null!==s4?(peg$reportedPos=s0,s1=peg$c86(s2,s4),null===s1?(peg$currPos=s0,s0=s1):s0=s1):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1)}else peg$currPos=s0,s0=peg$c1;return peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c81)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0}function peg$parseOlist(){var s0,s1,s2,key=38*peg$currPos+25,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,s0=peg$currPos,s1=peg$parseOlistElement(),null===s1&&(s1=peg$parseSinglelineComment()),null!==s1?(s2=peg$parseOlist(),null===s2&&(s2=peg$c2),null!==s2?(peg$reportedPos=s0,s1=peg$c88(s1,s2),null===s1?(peg$currPos=s0,s0=s1):s0=s1):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c87)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parseOlistElement(){var s0,s1,s2,s3,s4,s5,key=38*peg$currPos+26,cached=peg$cache[key];if(cached)return peg$currPos=cached.nextPos,cached.result;if(peg$silentFails++,s0=peg$currPos,s1=[],32===input.charCodeAt(peg$currPos)?(s2=peg$c82,peg$currPos++):(s2=null,0===peg$silentFails&&peg$fail(peg$c83)),null!==s2)for(;null!==s2;)s1.push(s2),32===input.charCodeAt(peg$currPos)?(s2=peg$c82,peg$currPos++):(s2=null,0===peg$silentFails&&peg$fail(peg$c83));else s1=peg$c1;return null!==s1?(s2=peg$parseDigits(),null!==s2?(46===input.charCodeAt(peg$currPos)?(s3=peg$c90,peg$currPos++):(s3=null,0===peg$silentFails&&peg$fail(peg$c91)),null!==s3?(s4=peg$parse_(),null!==s4?(s5=peg$parseSinglelineContent(),null!==s5?(peg$reportedPos=s0,s1=peg$c92(s2,s5),null===s1?(peg$currPos=s0,s0=s1):s0=s1):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c89)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0}function peg$parseDlist(){var s0,s1,s2,key=38*peg$currPos+27,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,s0=peg$currPos,s1=peg$parseDlistElement(),null===s1&&(s1=peg$parseSinglelineComment()),null!==s1?(s2=peg$parseDlist(),null===s2&&(s2=peg$c2),null!==s2?(peg$reportedPos=s0,s1=peg$c94(s1,s2),null===s1?(peg$currPos=s0,s0=s1):s0=s1):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c93)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parseDlistElement(){var s0,s1,s2,s3,s4,s5,s6,key=38*peg$currPos+28,cached=peg$cache[key];if(cached)return peg$currPos=cached.nextPos,cached.result;for(peg$silentFails++,s0=peg$currPos,s1=[],32===input.charCodeAt(peg$currPos)?(s2=peg$c82,peg$currPos++):(s2=null,0===peg$silentFails&&peg$fail(peg$c83));null!==s2;)s1.push(s2),32===input.charCodeAt(peg$currPos)?(s2=peg$c82,peg$currPos++):(s2=null,0===peg$silentFails&&peg$fail(peg$c83));return null!==s1?(58===input.charCodeAt(peg$currPos)?(s2=peg$c96,peg$currPos++):(s2=null,0===peg$silentFails&&peg$fail(peg$c97)),null!==s2?(32===input.charCodeAt(peg$currPos)?(s3=peg$c82,peg$currPos++):(s3=null,0===peg$silentFails&&peg$fail(peg$c83)),null!==s3?(s4=peg$parse_(),null!==s4?(s5=peg$parseSinglelineContent(),null!==s5?(s6=peg$parseDlistElementContent(),null!==s6?(peg$reportedPos=s0,s1=peg$c98(s5,s6),null===s1?(peg$currPos=s0,s0=s1):s0=s1):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c95)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0}function peg$parseDlistElementContent(){var s0,s1,s2,key=38*peg$currPos+29,cached=peg$cache[key];if(cached)return peg$currPos=cached.nextPos,cached.result;if(peg$silentFails++,s0=peg$currPos,s1=[],peg$c100.test(input.charAt(peg$currPos))?(s2=input.charAt(peg$currPos),peg$currPos++):(s2=null,0===peg$silentFails&&peg$fail(peg$c101)),null!==s2)for(;null!==s2;)s1.push(s2),peg$c100.test(input.charAt(peg$currPos))?(s2=input.charAt(peg$currPos),peg$currPos++):(s2=null,0===peg$silentFails&&peg$fail(peg$c101));else s1=peg$c1;return null!==s1?(s2=peg$parseSinglelineContent(),null!==s2?(peg$reportedPos=s0,s1=peg$c102(s2),null===s1?(peg$currPos=s0,s0=s1):s0=s1):(peg$currPos=s0,s0=peg$c1)):(peg$currPos=s0,s0=peg$c1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c99)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0}function peg$parseSinglelineComment(){var s0,s1,s2,s3,s4,s5,s6,key=38*peg$currPos+30,cached=peg$cache[key];if(cached)return peg$currPos=cached.nextPos,cached.result;if(peg$silentFails++,s0=peg$currPos,s1=peg$currPos,s2=peg$currPos,input.substr(peg$currPos,2)===peg$c104?(s3=peg$c104,peg$currPos+=2):(s3=null,0===peg$silentFails&&peg$fail(peg$c105)),null!==s3){for(s4=peg$currPos,s5=[],peg$c23.test(input.charAt(peg$currPos))?(s6=input.charAt(peg$currPos),peg$currPos++):(s6=null,0===peg$silentFails&&peg$fail(peg$c24));null!==s6;)s5.push(s6),peg$c23.test(input.charAt(peg$currPos))?(s6=input.charAt(peg$currPos),peg$currPos++):(s6=null,0===peg$silentFails&&peg$fail(peg$c24));null!==s5&&(s5=input.substring(s4,peg$currPos)),s4=s5,null!==s4?(s5=peg$parseNewline(),null===s5&&(s5=peg$c2),null!==s5?(s3=[s3,s4,s5],s2=s3):(peg$currPos=s2,s2=peg$c1)):(peg$currPos=s2,s2=peg$c1)}else peg$currPos=s2,s2=peg$c1;return null!==s2&&(s2=input.substring(s1,peg$currPos)),s1=s2,null!==s1&&(peg$reportedPos=s0,s1=peg$c106(s1)),null===s1?(peg$currPos=s0,s0=s1):s0=s1,peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c103)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0}function peg$parseDigits(){var s0,s1,s2,key=38*peg$currPos+31,cached=peg$cache[key];if(cached)return peg$currPos=cached.nextPos,cached.result;if(peg$silentFails++,s0=peg$currPos,s1=[],s2=peg$parseDigit(),null!==s2)for(;null!==s2;)s1.push(s2),s2=peg$parseDigit();else s1=peg$c1;return null!==s1&&(s1=input.substring(s0,peg$currPos)),s0=s1,peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c107)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0}function peg$parseDigit(){var s0,s1,key=38*peg$currPos+32,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,peg$c109.test(input.charAt(peg$currPos))?(s0=input.charAt(peg$currPos),peg$currPos++):(s0=null,0===peg$silentFails&&peg$fail(peg$c110)),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c108)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parseAZ(){var s0,s1,key=38*peg$currPos+33,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,peg$c112.test(input.charAt(peg$currPos))?(s0=input.charAt(peg$currPos),peg$currPos++):(s0=null,0===peg$silentFails&&peg$fail(peg$c113)),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c111)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parseNewline(){var s0,s1,key=38*peg$currPos+34,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,input.substr(peg$currPos,2)===peg$c115?(s0=peg$c115,peg$currPos+=2):(s0=null,0===peg$silentFails&&peg$fail(peg$c116)),null===s0&&(10===input.charCodeAt(peg$currPos)?(s0=peg$c117,peg$currPos++):(s0=null,0===peg$silentFails&&peg$fail(peg$c118))),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c114)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parse_(){var s0,s1,s2,key=38*peg$currPos+35,cached=peg$cache[key];if(cached)return peg$currPos=cached.nextPos,cached.result;for(peg$silentFails++,s0=peg$currPos,s1=[],s2=peg$parseSpace();null!==s2;)s1.push(s2),s2=peg$parseSpace();return null!==s1&&(s1=input.substring(s0,peg$currPos)),s0=s1,peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c119)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0}function peg$parseSpace(){var s0,s1,key=38*peg$currPos+36,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,peg$c121.test(input.charAt(peg$currPos))?(s0=input.charAt(peg$currPos),peg$currPos++):(s0=null,0===peg$silentFails&&peg$fail(peg$c122)),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c120)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}function peg$parseEOF(){var s0,s1,key=38*peg$currPos+37,cached=peg$cache[key];return cached?(peg$currPos=cached.nextPos,cached.result):(peg$silentFails++,s0=peg$currPos,peg$silentFails++,input.length>peg$currPos?(s1=input.charAt(peg$currPos),peg$currPos++):(s1=null,0===peg$silentFails&&peg$fail(peg$c18)),peg$silentFails--,null===s1?s0=peg$c2:(peg$currPos=s0,s0=peg$c1),peg$silentFails--,null===s0&&(s1=null,0===peg$silentFails&&peg$fail(peg$c123)),peg$cache[key]={nextPos:peg$currPos,result:s0},s0)}var peg$result,options=arguments.length>1?arguments[1]:{},peg$startRuleFunctions={Start:peg$parseStart},peg$startRuleFunction=peg$parseStart,peg$c0="start",peg$c1=null,peg$c2="",peg$c3=function(c){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"Start",content:c}},peg$c4="chapters",peg$c5=function(c,cc){var processed=[c];return""!==cc&&(Array.isArray(cc.content)?cc.content.forEach(function(c){processed.push(c)}):processed.push(cc.content)),{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"Chapters",content:processed}},peg$c6="chapter",peg$c7=function(headline,text){return{syntax:"Chapter",line:line(),column:column(),offset:offset(),endPos:peg$currPos,headline:headline,text:text}},peg$c8="headline",peg$c10="=",peg$c11='"="',peg$c12=function(level,cmd,label,caption){return{syntax:"Headline",line:line(),column:column(),offset:offset(),endPos:peg$currPos,level:level.length,cmd:cmd,label:label,caption:caption}},peg$c13="paragraphs",peg$c14=function(c,cc){var processed=[c];return""!==cc&&(Array.isArray(cc.content)?cc.content.forEach(function(c){processed.push(c)}):processed.push(cc.content)),{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"Paragraphs",content:processed}},peg$c15="paragraph",peg$c16=function(c){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"Paragraph",content:c}},peg$c17="contents",peg$c18="any character",peg$c19=function(c,cc){var processed=[c];return""!==cc&&(Array.isArray(cc.content)?cc.content.forEach(function(c){processed.push(c)}):processed.push(cc.content)),{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"Contents",content:processed}},peg$c20="content",peg$c21=function(c){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"Content",content:c}},peg$c22="text of content",peg$c23=/^[^\r\n]/,peg$c24="[^\\r\\n]",peg$c25=function(text){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"ContentText",text:text}},peg$c26="block element",peg$c27="//",peg$c28='"//"',peg$c29="{",peg$c30='"{"',peg$c31="//}",peg$c32='"//}"',peg$c33=function(symbol,args,contents){return{syntax:"BlockElement",line:line(),column:column(),offset:offset(),endPos:peg$currPos,symbol:symbol,args:args,content:contents}},peg$c34=function(symbol,args){return{syntax:"BlockElement",line:line(),column:column(),offset:offset(),endPos:peg$currPos,symbol:symbol,args:args,content:[]}},peg$c35="inline element",peg$c36="@<",peg$c37='"@<"',peg$c38=/^[^>\r\n]/,peg$c39="[^>\\r\\n]",peg$c40=">",peg$c41='">"',peg$c42="}",peg$c43='"}"',peg$c44=function(symbol,contents){return{syntax:"InlineElement",line:line(),column:column(),offset:offset(),endPos:peg$currPos,symbol:symbol,content:contents}},peg$c45="bracket argument",peg$c46="[",peg$c47='"["',peg$c48=/^[^\n\]]/,peg$c49="[^\\n\\]]",peg$c50="]",peg$c51='"]"',peg$c52=function(arg){return{syntax:"BracketArg",line:line(),column:column(),offset:offset(),endPos:peg$currPos,arg:arg}},peg$c53="brace argument",peg$c54=/^[^\n}]/,peg$c55="[^\\n}]",peg$c56=function(arg){return{syntax:"BraceArg",line:line(),column:column(),offset:offset(),endPos:peg$currPos,arg:arg}},peg$c57="contents of block element",peg$c58=function(c,cc){var processed=[c];return""!==cc&&(Array.isArray(cc.content)?cc.content.forEach(function(c){processed.push(c)}):processed.push(cc.content)),{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"BlockElementContents",content:processed}},peg$c59="content of block element",peg$c60=function(c){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"BlockElementContent",content:c}},peg$c61="text of block element",peg$c62=function(text){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"BlockElementContentText",text:text}},peg$c63="contents of inline element",peg$c64=function(c,cc){var processed=[c];return""!==cc&&(Array.isArray(cc.content)?cc.content.forEach(function(c){processed.push(c)}):processed.push(cc.content)),{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"InlineElementContents",content:processed}},peg$c65="content of inline element",peg$c66=function(c){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"InlineElementContent",content:c}},peg$c67="text of inline element",peg$c68=/^[^\r\n}]/,peg$c69="[^\\r\\n}]",peg$c70=function(text){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"InlineElementContentText",text:text}},peg$c71="inline content",peg$c72=function(c){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"SinglelineContent",content:c}},peg$c73="children of inline content",peg$c74=function(c,cc){var processed=[c];return""!==cc&&(Array.isArray(cc.content)?cc.content.forEach(function(c){processed.push(c)}):processed.push(cc.content)),{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"ContentInlines",content:processed}},peg$c75="child of inline content",peg$c76=function(c){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"ContentInline",content:c}},peg$c77="text of child of inline content",peg$c78=function(text){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"ContentInlineText",text:text}},peg$c79="ulist",peg$c80=function(c,cc){var processed=[c];return""!==cc&&(Array.isArray(cc.content)?cc.content.forEach(function(c){processed.push(c)}):processed.push(cc.content)),{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"Ulist",content:processed}},peg$c81="ulist element",peg$c82=" ",peg$c83='" "',peg$c84="*",peg$c85='"*"',peg$c86=function(level,text){return{syntax:"UlistElement",line:line(),column:column(),offset:offset(),endPos:peg$currPos,level:level.length,text:text}},peg$c87="olist",peg$c88=function(c,cc){var processed=[c];return""!==cc&&(Array.isArray(cc.content)?cc.content.forEach(function(c){processed.push(c)}):processed.push(cc.content)),{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"Olist",content:processed}},peg$c89="olist element",peg$c90=".",peg$c91='"."',peg$c92=function(n,text){return{syntax:"OlistElement",line:line(),column:column(),offset:offset(),endPos:peg$currPos,no:parseInt(n),text:text}},peg$c93="dlist",peg$c94=function(c,cc){var processed=[c];return""!==cc&&(Array.isArray(cc.content)?cc.content.forEach(function(c){processed.push(c)}):processed.push(cc.content)),{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"Dlist",content:processed}},peg$c95="dlist element",peg$c96=":",peg$c97='":"',peg$c98=function(text,content){return{syntax:"DlistElement",line:line(),column:column(),offset:offset(),endPos:peg$currPos,text:text,content:content}},peg$c99="content of dlist element",peg$c100=/^[ \t]/,peg$c101="[ \\t]",peg$c102=function(c){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"DlistElementContent",content:c}},peg$c103="signle line comment",peg$c104="#@",peg$c105='"#@"',peg$c106=function(text){return{line:line(),column:column(),offset:offset(),endPos:peg$currPos,syntax:"SinglelineComment",text:text}},peg$c107="digits",peg$c108="digit",peg$c109=/^[0-9]/,peg$c110="[0-9]",peg$c111="lower alphabet",peg$c112=/^[a-z]/,peg$c113="[a-z]",peg$c114="newline",peg$c115="\r\n",peg$c116='"\\r\\n"',peg$c117="\n",peg$c118='"\\n"',peg$c119="spacer",peg$c120="space",peg$c121=/^[ \t\r\n]/,peg$c122="[ \\t\\r\\n]",peg$c123="end of file",peg$currPos=0,peg$reportedPos=0,peg$cachedPos=0,peg$cachedPosDetails={line:1,column:1,seenCR:!1},peg$maxFailPos=0,peg$maxFailExpected=[],peg$silentFails=0,peg$cache={};if("startRule"in options){if(!(options.startRule in peg$startRuleFunctions))throw new Error("Can't start parsing from rule \""+options.startRule+'".');peg$startRuleFunction=peg$startRuleFunctions[options.startRule]}if(peg$result=peg$startRuleFunction(),null!==peg$result&&peg$currPos===input.length)return peg$result;throw peg$cleanupExpected(peg$maxFailExpected),peg$reportedPos=Math.max(peg$currPos,peg$maxFailPos),new SyntaxError(peg$maxFailExpected,peg$reportedPos<input.length?input.charAt(peg$reportedPos):null,peg$reportedPos,peg$computePosDetails(peg$reportedPos).line,peg$computePosDetails(peg$reportedPos).column)}return peg$subclass(SyntaxError,Error),{SyntaxError:SyntaxError,parse:parse}}(),ReVIEW;!function(ReVIEW){function isNodeJS(){return"undefined"==typeof window}function flatten(data){return data.some(function(d){return Array.isArray(d)})?flatten(data.reduce(function(p,c){return p.concat(c)},[])):data}function nodeToString(process,node){return process.input.substring(node.offset,node.endPos)}function nodeContentToString(process,node){var minPos=Number.MAX_VALUE,maxPos=-1,childVisitor={visitDefaultPre:function(node){minPos=Math.min(minPos,node.offset),maxPos=Math.max(maxPos,node.endPos)}};return ReVIEW.visit(node,{visitDefaultPre:function(){},visitNodePre:function(node){return node.childNodes.forEach(function(child){return ReVIEW.visit(child,childVisitor)}),!1},visitHeadlinePre:function(node){return ReVIEW.visit(node.caption,childVisitor),!1},visitUlistPre:function(node){return ReVIEW.visit(node.text,childVisitor),!1},visitDlistPre:function(node){return ReVIEW.visit(node.text,childVisitor),ReVIEW.visit(node.content,childVisitor),!1},visitOlistPre:function(node){return ReVIEW.visit(node.text,childVisitor),!1},visitTextPre:function(){return ReVIEW.visit(node,childVisitor),!1}}),0>maxPos?"":process.input.substring(minPos,maxPos)}function findChapter(node,level){var chapter=null;return ReVIEW.walk(node,function(node){return node instanceof ReVIEW.Parse.ChapterSyntaxTree&&(chapter=node.toChapter(),"undefined"==typeof level||chapter.level===level)?null:node.parentNode}),chapter}function stringRepeat(times,src){return new Array(times+1).join(src)}ReVIEW.isNodeJS=isNodeJS,ReVIEW.flatten=flatten,ReVIEW.nodeToString=nodeToString,ReVIEW.nodeContentToString=nodeContentToString,ReVIEW.findChapter=findChapter,function(IO){function read(path){var fs=require("fs");return fs.readFileSync(path,"utf8")}function write(path,content){var fs=require("fs");fs.writeFileSync(path,content)}IO.read=read,IO.write=write}(ReVIEW.IO||(ReVIEW.IO={})),ReVIEW.IO,ReVIEW.stringRepeat=stringRepeat}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){ReVIEW.ja={sample:"こんちゃーす！",description:{headline:'チャプターの始まりを示します。\n"= 見出し" という形式で書きます。',block_list:'リストを示します。技術書ではプログラムコードの掲載に使います。\n//list[label][caption]{\nalert("Hello!");\n//}\n という形式で書きます。',inline_list:'リストへの参照を示します。\n//list[hoge][caption]{alert("Hello!");\n//}\n を参照する時は @<list>{hoge} と書きます。',inline_hd:"TODO 後で書く。見出し参照を作成する。",inline_code:'短いプログラムコードを記述します。\n@<code>{alert("Hello!");}\n長いソースコードにはlist記法を使いましょう。',inline_br:"改行を示します。リスト内での改行や、段落を変えずに改行をしたい場合に使います。",ulist:"番号なし箇条書きを示します。*記号をつなげて書くとネストした箇条書きにする事ができます。",inline_b:"ボールド(太字)にします。\n@<b>{この部分が太字になる}",inline_href:"リンクを示します。URLを書きたい場合に使います。\n@<href>{https://github.com/vvakame/review.js}",inline_tt:"囲まれたテキストを等幅フォントで表示します。",inline_em:"テキストを強調します。\n@<em>{このように強調されます}"},compile:{file_not_exists:"ファイル %s が開けません",block_not_supported:"%s というブロック構文はサポートされていません",inline_not_supported:"%s というインライン構文はサポートされていません",part_is_missing:"パート %s が見つかりません",chapter_is_missing:"チャプター %s が見つかりません",reference_is_missing:"参照先 %s の %s が見つかりません",duplicated_label:"ラベルに重複があるようです",args_length_mismatch:"引数の数に齟齬があります 期待値 %s, 実際 %s",body_string_only:"内容は全て文字でなければいけません",chapter_not_toplevel:"深さ1のチャプターは最上位になければいけません",chapter_topleve_eq1:"最上位のチャプターは深さ1のものでなければいけません",chapter_level_omission:"深さ%sのチャプターは深さ%sのチャプターに属していなければいけません 今は深さ%sのチャプターの下にいます"},builder:{chapter:"第%d章",list:"リスト%s.%s"}}}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){ReVIEW.en={sample:"Hello!"}}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){!function(i18n){function setup(lang){"undefined"==typeof lang&&(lang="ja"),"undefined"!=typeof i18next.backend?(i18next.backend({fetchOne:function(lng,ns,func){func(null,data[lng]||data[lang])}}),i18next.init({lng:lang})):i18next.init({lng:lang,customLoad:function(lng,ns,options,loadComplete){loadComplete(null,data[lng]||data["ja-JP"])}})}function t(str){for(var args=[],_i=0;_i<arguments.length-1;_i++)args[_i]=arguments[_i+1];return i18next.t(str,{postProcess:"sprintf",sprintf:args})}i18n.setup=setup,i18n.t=t;var i18next;i18next=ReVIEW.isNodeJS()?require("i18next"):window.i18n;var data={ja:ReVIEW.ja,en:ReVIEW.en};setup()}(ReVIEW.i18n||(ReVIEW.i18n={})),ReVIEW.i18n}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){function walk(ast,actor){var next=actor(ast);next&&walk(next,actor)}function visit(ast,v){var newV={visitDefaultPre:v.visitDefaultPre,visitDefaultPost:v.visitDefaultPost||function(){},visitBlockElementPre:v.visitBlockElementPre||v.visitNodePre||v.visitDefaultPre,visitBlockElementPost:v.visitBlockElementPost||v.visitNodePost||v.visitDefaultPost||function(){},visitInlineElementPre:v.visitInlineElementPre||v.visitNodePre||v.visitDefaultPre,visitInlineElementPost:v.visitInlineElementPost||v.visitNodePost||v.visitDefaultPost||function(){},visitNodePre:v.visitNodePre||v.visitDefaultPre,visitNodePost:v.visitNodePost||v.visitDefaultPost||function(){},visitArgumentPre:v.visitArgumentPre||v.visitDefaultPre,visitArgumentPost:v.visitArgumentPost||v.visitDefaultPost||function(){},visitChapterPre:v.visitChapterPre||v.visitNodePre||v.visitDefaultPre,visitChapterPost:v.visitChapterPost||v.visitNodePost||v.visitDefaultPost||function(){},visitHeadlinePre:v.visitHeadlinePre||v.visitDefaultPre,visitHeadlinePost:v.visitHeadlinePost||v.visitDefaultPost||function(){},visitUlistPre:v.visitUlistPre||v.visitNodePre||v.visitDefaultPre,visitUlistPost:v.visitUlistPost||v.visitNodePost||v.visitDefaultPost||function(){},visitOlistPre:v.visitOlistPre||v.visitDefaultPre,visitOlistPost:v.visitOlistPost||v.visitDefaultPost||function(){},visitDlistPre:v.visitDlistPre||v.visitDefaultPre,visitDlistPost:v.visitDlistPost||v.visitDefaultPost||function(){},visitTextPre:v.visitTextPre||v.visitDefaultPre,visitTextPost:v.visitTextPost||v.visitDefaultPost||function(){}};newV.visitDefaultPre=newV.visitDefaultPre.bind(v),newV.visitDefaultPost=newV.visitDefaultPost.bind(v),newV.visitBlockElementPre=newV.visitBlockElementPre.bind(v),newV.visitBlockElementPost=newV.visitBlockElementPost.bind(v),newV.visitInlineElementPre=newV.visitInlineElementPre.bind(v),newV.visitInlineElementPost=newV.visitInlineElementPost.bind(v),newV.visitNodePre=newV.visitNodePre.bind(v),newV.visitNodePost=newV.visitNodePost.bind(v),newV.visitArgumentPre=newV.visitArgumentPre.bind(v),newV.visitArgumentPost=newV.visitArgumentPost.bind(v),newV.visitChapterPre=newV.visitChapterPre.bind(v),newV.visitChapterPost=newV.visitChapterPost.bind(v),newV.visitHeadlinePre=newV.visitHeadlinePre.bind(v),newV.visitHeadlinePost=newV.visitHeadlinePost.bind(v),newV.visitUlistPre=newV.visitUlistPre.bind(v),newV.visitUlistPost=newV.visitUlistPost.bind(v),newV.visitOlistPre=newV.visitOlistPre.bind(v),newV.visitOlistPost=newV.visitOlistPost.bind(v),newV.visitDlistPre=newV.visitDlistPre.bind(v),newV.visitDlistPost=newV.visitDlistPost.bind(v),newV.visitTextPre=newV.visitTextPre.bind(v),newV.visitTextPost=newV.visitTextPost.bind(v),visitSub(null,ast,newV)}function visitSub(parent,ast,v){if(ast instanceof ReVIEW.Parse.BlockElementSyntaxTree){var block=ast.toBlockElement(),ret=v.visitBlockElementPre(block,parent);"undefined"==typeof ret||"boolean"==typeof ret&&ret?(block.args.forEach(function(next){visitSub(ast,next,v)}),block.childNodes.forEach(function(next){visitSub(ast,next,v)})):"function"==typeof ret&&ret(v),v.visitBlockElementPost(block,parent)}else if(ast instanceof ReVIEW.Parse.InlineElementSyntaxTree){var inline=ast.toInlineElement(),ret=v.visitInlineElementPre(inline,parent);"undefined"==typeof ret||"boolean"==typeof ret&&ret?inline.childNodes.forEach(function(next){visitSub(ast,next,v)}):"function"==typeof ret&&ret(v),v.visitInlineElementPost(inline,parent)}else if(ast instanceof ReVIEW.Parse.ArgumentSyntaxTree){var arg=ast.toArgument(),ret=v.visitArgumentPre(arg,parent);
"function"==typeof ret&&ret(v),v.visitArgumentPost(arg,parent)}else if(ast instanceof ReVIEW.Parse.ChapterSyntaxTree){var chap=ast.toChapter(),ret=v.visitChapterPre(chap,parent);"undefined"==typeof ret||"boolean"==typeof ret&&ret?(visitSub(ast,chap.headline,v),chap.text&&chap.text.forEach(function(next){visitSub(ast,next,v)}),chap.childNodes.forEach(function(next){visitSub(ast,next,v)})):"function"==typeof ret&&ret(v),v.visitChapterPost(chap,parent)}else if(ast instanceof ReVIEW.Parse.HeadlineSyntaxTree){var head=ast.toHeadline(),ret=v.visitHeadlinePre(head,parent);"undefined"==typeof ret||"boolean"==typeof ret&&ret?(visitSub(ast,head.cmd,v),visitSub(ast,head.label,v),visitSub(ast,head.caption,v)):"function"==typeof ret&&ret(v),v.visitHeadlinePost(head,parent)}else if(ast instanceof ReVIEW.Parse.UlistElementSyntaxTree){var ul=ast.toUlist(),ret=v.visitUlistPre(ul,parent);"undefined"==typeof ret||"boolean"==typeof ret&&ret?(visitSub(ast,ul.text,v),ul.childNodes.forEach(function(next){visitSub(ast,next,v)})):"function"==typeof ret&&ret(v),v.visitUlistPost(ul,parent)}else if(ast instanceof ReVIEW.Parse.OlistElementSyntaxTree){var ol=ast.toOlist(),ret=v.visitOlistPre(ol,parent);"undefined"==typeof ret||"boolean"==typeof ret&&ret?visitSub(ast,ol.text,v):"function"==typeof ret&&ret(v),v.visitOlistPost(ol,parent)}else if(ast instanceof ReVIEW.Parse.DlistElementSyntaxTree){var dl=ast.toDlist(),ret=v.visitDlistPre(dl,parent);"undefined"==typeof ret||"boolean"==typeof ret&&ret?(visitSub(ast,dl.text,v),visitSub(ast,dl.content,v)):"function"==typeof ret&&ret(v),v.visitDlistPost(dl,parent)}else if(ast instanceof ReVIEW.Parse.NodeSyntaxTree){var node=ast.toNode(),ret=v.visitNodePre(node,parent);"undefined"==typeof ret||"boolean"==typeof ret&&ret?node.childNodes.forEach(function(next){visitSub(ast,next,v)}):"function"==typeof ret&&ret(v),v.visitNodePost(node,parent)}else if(ast instanceof ReVIEW.Parse.TextNodeSyntaxTree){var text=ast.toTextNode(),ret=v.visitTextPre(text,parent);"function"==typeof ret&&ret(v),v.visitTextPost(text,parent)}else if(ast){var ret=v.visitDefaultPre(parent,ast);"function"==typeof ret&&ret(v),v.visitDefaultPost(parent,ast)}}!function(){}(ReVIEW.Parse||(ReVIEW.Parse={})),ReVIEW.Parse,ReVIEW.Parse.SyntaxTree,ReVIEW.Parse.BlockElementSyntaxTree,ReVIEW.Parse.InlineElementSyntaxTree,ReVIEW.Parse.ArgumentSyntaxTree,ReVIEW.Parse.ChapterSyntaxTree,ReVIEW.Parse.HeadlineSyntaxTree,ReVIEW.Parse.UlistElementSyntaxTree,ReVIEW.Parse.OlistElementSyntaxTree,ReVIEW.Parse.DlistElementSyntaxTree,ReVIEW.Parse.NodeSyntaxTree,ReVIEW.Parse.TextNodeSyntaxTree,ReVIEW.walk=walk,ReVIEW.visit=visit}(ReVIEW||(ReVIEW={}));var __extends=this.__extends||function(d,b){function __(){this.constructor=d}for(var p in b)b.hasOwnProperty(p)&&(d[p]=b[p]);__.prototype=b.prototype,d.prototype=new __},ReVIEW;!function(ReVIEW){!function(Parse){function parse(input){var rawResult=PEG.parse(input),root=transform(rawResult).toNode();0!==root.childNodes.length&&reconstruct(root.childNodes[0].toNode(),function(chapter){return chapter.headline.level});var ulistSet=[];return ReVIEW.visit(root,{visitDefaultPre:function(ast){ast.ruleName===RuleName.Ulist&&ulistSet.push(ast.toNode())}}),ulistSet.forEach(function(ulist){reconstruct(ulist,function(ulistElement){return ulistElement.level})}),ReVIEW.visit(root,{visitDefaultPre:function(ast,parent){ast.parentNode=parent}}),{ast:root,cst:rawResult}}function transform(rawResult){if(""===rawResult)return null;var rule=RuleName[rawResult.syntax];if("undefined"==typeof rule)throw new ParseError(rawResult,"unknown rule: "+rawResult.syntax);switch(rule){case RuleName.Chapter:return new ChapterSyntaxTree(rawResult);case RuleName.BlockElement:return new BlockElementSyntaxTree(rawResult);case RuleName.Headline:return new HeadlineSyntaxTree(rawResult);case RuleName.InlineElement:return new InlineElementSyntaxTree(rawResult);case RuleName.BracketArg:case RuleName.BraceArg:return new ArgumentSyntaxTree(rawResult);case RuleName.UlistElement:return new UlistElementSyntaxTree(rawResult);case RuleName.OlistElement:return new OlistElementSyntaxTree(rawResult);case RuleName.DlistElement:return new DlistElementSyntaxTree(rawResult);case RuleName.ContentText:case RuleName.BlockElementContentText:case RuleName.InlineElementContentText:case RuleName.ContentInlineText:case RuleName.SinglelineComment:return new TextNodeSyntaxTree(rawResult);case RuleName.Chapters:case RuleName.Paragraphs:case RuleName.Contents:case RuleName.BlockElementContents:case RuleName.InlineElementContents:case RuleName.ContentInlines:case RuleName.Ulist:case RuleName.Olist:case RuleName.Dlist:return new NodeSyntaxTree(rawResult);case RuleName.Start:case RuleName.Paragraph:case RuleName.DlistElementContent:return new NodeSyntaxTree(rawResult);case RuleName.Content:case RuleName.BlockElementContent:case RuleName.InlineElementContent:case RuleName.SinglelineContent:case RuleName.ContentInline:return transform(rawResult.content);default:return new SyntaxTree(rawResult)}}function reconstruct(node,pickLevel){var originalChildNodes=node.childNodes;node.childNodes=[];var nodeSets=[],currentSet=[];originalChildNodes.forEach(function(child){0===currentSet.length?currentSet.push(child):pickLevel(currentSet[0])<pickLevel(child)?currentSet.push(child):(nodeSets.push(currentSet),currentSet=[],currentSet.push(child))}),0!==currentSet.length&&nodeSets.push(currentSet),nodeSets.forEach(function(nodes){var parent=nodes[0];node.childNodes.push(parent),nodes.splice(1).forEach(function(child){parent.childNodes.push(child)}),reconstruct(parent,pickLevel)})}Parse.parse=parse,Parse.transform=transform;var ParseError=function(){function ParseError(syntax,message){this.syntax=syntax,this.message=message,Error.captureStackTrace&&Error.captureStackTrace(this,ParseError),this.name="ParseError"}return ParseError}();Parse.ParseError=ParseError,function(RuleName){RuleName[RuleName.SyntaxError=0]="SyntaxError",RuleName[RuleName.Start=1]="Start",RuleName[RuleName.Chapters=2]="Chapters",RuleName[RuleName.Chapter=3]="Chapter",RuleName[RuleName.Headline=4]="Headline",RuleName[RuleName.Paragraphs=5]="Paragraphs",RuleName[RuleName.Paragraph=6]="Paragraph",RuleName[RuleName.Contents=7]="Contents",RuleName[RuleName.Content=8]="Content",RuleName[RuleName.ContentText=9]="ContentText",RuleName[RuleName.BlockElement=10]="BlockElement",RuleName[RuleName.InlineElement=11]="InlineElement",RuleName[RuleName.BracketArg=12]="BracketArg",RuleName[RuleName.BraceArg=13]="BraceArg",RuleName[RuleName.BlockElementContents=14]="BlockElementContents",RuleName[RuleName.BlockElementContent=15]="BlockElementContent",RuleName[RuleName.BlockElementContentText=16]="BlockElementContentText",RuleName[RuleName.InlineElementContents=17]="InlineElementContents",RuleName[RuleName.InlineElementContent=18]="InlineElementContent",RuleName[RuleName.InlineElementContentText=19]="InlineElementContentText",RuleName[RuleName.SinglelineContent=20]="SinglelineContent",RuleName[RuleName.ContentInlines=21]="ContentInlines",RuleName[RuleName.ContentInline=22]="ContentInline",RuleName[RuleName.ContentInlineText=23]="ContentInlineText",RuleName[RuleName.Ulist=24]="Ulist",RuleName[RuleName.UlistElement=25]="UlistElement",RuleName[RuleName.Olist=26]="Olist",RuleName[RuleName.OlistElement=27]="OlistElement",RuleName[RuleName.Dlist=28]="Dlist",RuleName[RuleName.DlistElement=29]="DlistElement",RuleName[RuleName.DlistElementContent=30]="DlistElementContent",RuleName[RuleName.SinglelineComment=31]="SinglelineComment"}(Parse.RuleName||(Parse.RuleName={}));var RuleName=Parse.RuleName,SyntaxTree=function(){function SyntaxTree(data){if(this.ruleName=RuleName[data.syntax],"undefined"==typeof this.ruleName)throw new ParseError(data,"unknown rule: "+data.syntax);this.offset=data.offset,this.line=data.line,this.column=data.column,this.endPos=data.endPos}return SyntaxTree.prototype.toJSON=function(){var result={};for(var k in this)"ruleName"===k?result[k]=RuleName[this[k]]:"fqn"===k||"parentNode"!==k&&"function"!=typeof this[k]&&(result[k]=this[k]);return result},SyntaxTree.prototype.toString=function(indentLevel){"undefined"==typeof indentLevel&&(indentLevel=0);var result=this.makeIndent(indentLevel)+"SyntaxTree:[\n";return result+=this.makeIndent(indentLevel+1)+"offset = "+this.offset+",\n",result+=this.makeIndent(indentLevel+1)+"line="+this.line+",\n",result+=this.makeIndent(indentLevel+1)+"column="+this.column+",\n",result+=this.makeIndent(indentLevel+1)+"name="+RuleName[this.ruleName]+",\n",this.toStringHook(indentLevel,result),result+=this.makeIndent(indentLevel)+"]"},SyntaxTree.prototype.makeIndent=function(indentLevel){for(var indent="",i=0;indentLevel>i;i++)indent+="  ";return indent},SyntaxTree.prototype.toStringHook=function(){},SyntaxTree.prototype.checkNumber=function(value){if("number"!=typeof value)throw new Error("number required. actual:"+typeof value+":"+value);return value},SyntaxTree.prototype.checkString=function(value){if("string"!=typeof value)throw new Error("string required. actual:"+typeof value+":"+value);return value},SyntaxTree.prototype.checkObject=function(value){if("object"!=typeof value)throw new Error("object required. actual:"+typeof value+":"+value);return value},SyntaxTree.prototype.checkArray=function(value){if(Array.isArray(value))return value;throw new Error("array required. actual:"+typeof value+":"+value)},SyntaxTree.prototype.toOtherNode=function(clazz){if(this instanceof clazz)return this;throw new Error("this node is not "+clazz.name+", actual "+this.constructor.name)},SyntaxTree.prototype.toNode=function(){return this.toOtherNode(NodeSyntaxTree)},SyntaxTree.prototype.toBlockElement=function(){return this.toOtherNode(BlockElementSyntaxTree)},SyntaxTree.prototype.toInlineElement=function(){return this.toOtherNode(InlineElementSyntaxTree)},SyntaxTree.prototype.toArgument=function(){return this.toOtherNode(ArgumentSyntaxTree)},SyntaxTree.prototype.toChapter=function(){return this.toOtherNode(ChapterSyntaxTree)},SyntaxTree.prototype.toHeadline=function(){return this.toOtherNode(HeadlineSyntaxTree)},SyntaxTree.prototype.toUlist=function(){return this.toOtherNode(UlistElementSyntaxTree)},SyntaxTree.prototype.toOlist=function(){return this.toOtherNode(OlistElementSyntaxTree)},SyntaxTree.prototype.toDlist=function(){return this.toOtherNode(DlistElementSyntaxTree)},SyntaxTree.prototype.toTextNode=function(){return this.toOtherNode(TextNodeSyntaxTree)},SyntaxTree}();Parse.SyntaxTree=SyntaxTree;var NodeSyntaxTree=function(_super){function NodeSyntaxTree(data){_super.call(this,data),this.childNodes=[],this.processChildNodes(data.content)}return __extends(NodeSyntaxTree,_super),NodeSyntaxTree.prototype.processChildNodes=function(content){var _this=this;Array.isArray(content)?content.forEach(function(rawResult){var tree=transform(rawResult);tree&&_this.childNodes.push(tree)}):""!==content&&content&&!function(rawResult){var tree=transform(rawResult);tree&&_this.childNodes.push(tree)}(content)},NodeSyntaxTree.prototype.toStringHook=function(indentLevel,result){0!==this.childNodes.length&&(result+=this.makeIndent(indentLevel+1)+"childNodes["+this.childNodes.length+"]=[\n",this.childNodes.forEach(function(node){result+=node.toString(indentLevel+2),result+="\n"}),result+=this.makeIndent(indentLevel+1)+"]\n")},NodeSyntaxTree}(SyntaxTree);Parse.NodeSyntaxTree=NodeSyntaxTree;var ChapterSyntaxTree=function(_super){function ChapterSyntaxTree(data){_super.call(this,data),this.headline=transform(this.checkObject(data.headline)).toHeadline(),"string"!=typeof data.text&&(this.text=this.checkArray(data.text.content).map(function(data){return transform(data)}),delete this.childNodes,this.childNodes=[])}return __extends(ChapterSyntaxTree,_super),Object.defineProperty(ChapterSyntaxTree.prototype,"level",{get:function(){return this.headline.level},enumerable:!0,configurable:!0}),Object.defineProperty(ChapterSyntaxTree.prototype,"fqn",{get:function(){var chapters=[];ReVIEW.walk(this,function(node){return node instanceof ReVIEW.Parse.ChapterSyntaxTree&&chapters.unshift(node.toChapter()),node.parentNode});var result=chapters.map(function(chapter){return chapter.no}).join(".");return result},enumerable:!0,configurable:!0}),ChapterSyntaxTree}(NodeSyntaxTree);Parse.ChapterSyntaxTree=ChapterSyntaxTree;var HeadlineSyntaxTree=function(_super){function HeadlineSyntaxTree(data){_super.call(this,data),this.level=this.checkNumber(data.level),""!==data.cmd&&(this.cmd=transform(this.checkObject(data.cmd)).toArgument()),""!==data.label&&(this.label=transform(this.checkObject(data.label)).toArgument()),this.caption=transform(this.checkObject(data.caption)).toNode()}return __extends(HeadlineSyntaxTree,_super),HeadlineSyntaxTree}(SyntaxTree);Parse.HeadlineSyntaxTree=HeadlineSyntaxTree;var BlockElementSyntaxTree=function(_super){function BlockElementSyntaxTree(data){_super.call(this,data),this.symbol=this.checkString(data.symbol),this.args=this.checkArray(data.args).map(function(data){return transform(data).toArgument()})}return __extends(BlockElementSyntaxTree,_super),BlockElementSyntaxTree}(NodeSyntaxTree);Parse.BlockElementSyntaxTree=BlockElementSyntaxTree;var InlineElementSyntaxTree=function(_super){function InlineElementSyntaxTree(data){_super.call(this,data),this.symbol=this.checkString(data.symbol)}return __extends(InlineElementSyntaxTree,_super),InlineElementSyntaxTree}(NodeSyntaxTree);Parse.InlineElementSyntaxTree=InlineElementSyntaxTree;var ArgumentSyntaxTree=function(_super){function ArgumentSyntaxTree(data){_super.call(this,data),this.arg=this.checkString(data.arg)}return __extends(ArgumentSyntaxTree,_super),ArgumentSyntaxTree}(SyntaxTree);Parse.ArgumentSyntaxTree=ArgumentSyntaxTree;var UlistElementSyntaxTree=function(_super){function UlistElementSyntaxTree(data){_super.call(this,data),this.level=this.checkNumber(data.level),this.text=transform(this.checkObject(data.text)),delete this.childNodes,this.childNodes=[]}return __extends(UlistElementSyntaxTree,_super),UlistElementSyntaxTree}(NodeSyntaxTree);Parse.UlistElementSyntaxTree=UlistElementSyntaxTree;var OlistElementSyntaxTree=function(_super){function OlistElementSyntaxTree(data){_super.call(this,data),this.no=this.checkNumber(data.no),this.text=transform(this.checkObject(data.text))}return __extends(OlistElementSyntaxTree,_super),OlistElementSyntaxTree}(SyntaxTree);Parse.OlistElementSyntaxTree=OlistElementSyntaxTree;var DlistElementSyntaxTree=function(_super){function DlistElementSyntaxTree(data){_super.call(this,data),this.text=transform(this.checkObject(data.text)),this.content=transform(this.checkObject(data.content))}return __extends(DlistElementSyntaxTree,_super),DlistElementSyntaxTree}(SyntaxTree);Parse.DlistElementSyntaxTree=DlistElementSyntaxTree;var TextNodeSyntaxTree=function(_super){function TextNodeSyntaxTree(data){_super.call(this,data),this.text=this.checkString(data.text)}return __extends(TextNodeSyntaxTree,_super),TextNodeSyntaxTree}(SyntaxTree);Parse.TextNodeSyntaxTree=TextNodeSyntaxTree}(ReVIEW.Parse||(ReVIEW.Parse={})),ReVIEW.Parse}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){!function(Build){var t=ReVIEW.i18n.t;ReVIEW.Parse.SyntaxTree,ReVIEW.Parse.NodeSyntaxTree,ReVIEW.Parse.BlockElementSyntaxTree,ReVIEW.Parse.InlineElementSyntaxTree,ReVIEW.Parse.HeadlineSyntaxTree,ReVIEW.Parse.TextNodeSyntaxTree,ReVIEW.Parse.ChapterSyntaxTree,function(SyntaxType){SyntaxType[SyntaxType.Block=0]="Block",SyntaxType[SyntaxType.Inline=1]="Inline",SyntaxType[SyntaxType.Other=2]="Other"}(Build.SyntaxType||(Build.SyntaxType={}));var SyntaxType=Build.SyntaxType,AcceptableSyntaxes=function(){function AcceptableSyntaxes(acceptableSyntaxes){this.acceptableSyntaxes=acceptableSyntaxes}return AcceptableSyntaxes.prototype.find=function(node){var results;if(node instanceof ReVIEW.Parse.InlineElementSyntaxTree){var inline=node.toInlineElement();results=this.inlines.filter(function(s){return s.symbolName===inline.symbol})}else if(node instanceof ReVIEW.Parse.BlockElementSyntaxTree){var block=node.toBlockElement();results=this.blocks.filter(function(s){return s.symbolName===block.symbol})}else results=this.others.filter(function(s){return node instanceof s.clazz});return results},Object.defineProperty(AcceptableSyntaxes.prototype,"inlines",{get:function(){return this.acceptableSyntaxes.filter(function(s){return s.type===SyntaxType.Inline})},enumerable:!0,configurable:!0}),Object.defineProperty(AcceptableSyntaxes.prototype,"blocks",{get:function(){return this.acceptableSyntaxes.filter(function(s){return s.type===SyntaxType.Block})},enumerable:!0,configurable:!0}),Object.defineProperty(AcceptableSyntaxes.prototype,"others",{get:function(){return this.acceptableSyntaxes.filter(function(s){return s.type===SyntaxType.Other})},enumerable:!0,configurable:!0}),AcceptableSyntaxes.prototype.toJSON=function(){return{rev:"1",SyntaxType:SyntaxType,acceptableSyntaxes:this.acceptableSyntaxes}},AcceptableSyntaxes}();Build.AcceptableSyntaxes=AcceptableSyntaxes;var AcceptableSyntax=function(){function AcceptableSyntax(){this.argsLength=[]}return AcceptableSyntax.prototype.toJSON=function(){return{type:this.type,"class":this.clazz?this.clazz.name:void 0,symbolName:this.symbolName,argsLength:0!==this.argsLength.length?this.argsLength:void 0,description:this.description}},AcceptableSyntax}();Build.AcceptableSyntax=AcceptableSyntax;var AnalyzerError=function(){function AnalyzerError(message){this.message=message,this.name="AnalyzerError";var E=Error;E.captureStackTrace&&E.captureStackTrace(this,AnalyzerError)}return AnalyzerError}();Build.AnalyzerError=AnalyzerError;var AnalyzeProcess=function(){function AnalyzeProcess(){this.acceptableSyntaxes=[]}return AnalyzeProcess.prototype.prepare=function(){this.current=new AcceptableSyntax},AnalyzeProcess.prototype.build=function(methodName){switch(0===methodName.indexOf("block_")?(this.current.type=this.current.type||SyntaxType.Block,this.current.symbolName=this.current.symbolName||methodName.substring("block_".length)):0===methodName.indexOf("inline_")?(this.current.type=this.current.type||SyntaxType.Inline,this.current.symbolName=this.current.symbolName||methodName.substring("inline_".length)):(this.current.type=this.current.type||SyntaxType.Other,this.current.symbolName=this.current.symbolName||methodName),this.current.type){case SyntaxType.Block:if(0===this.current.argsLength.length)throw new AnalyzerError("must call builder.checkArgsLength(...number[]) in "+methodName);break;case SyntaxType.Other:if(!this.current.clazz)throw new AnalyzerError("must call builder.setClass(class) in "+methodName);break;case SyntaxType.Inline:}if(!this.current.description)throw new AnalyzerError("must call builder.setDescription(string) in "+methodName);if(!this.current.process)throw new AnalyzerError("must call builder.processNode(func) in "+methodName);this.acceptableSyntaxes.push(this.current)},AnalyzeProcess.prototype.setSyntaxType=function(type){this.current.type=type},AnalyzeProcess.prototype.setClass=function(clazz){this.current.clazz=clazz},AnalyzeProcess.prototype.setSymbol=function(symbolName){this.current.symbolName=symbolName},AnalyzeProcess.prototype.setDescription=function(description){this.current.description=description},AnalyzeProcess.prototype.checkArgsLength=function(){for(var argsLength=[],_i=0;_i<arguments.length-0;_i++)argsLength[_i]=arguments[_i+0];this.current.argsLength=argsLength},AnalyzeProcess.prototype.processNode=function(func){this.current.process=func},AnalyzeProcess}(),DefaultAnalyzer=function(){function DefaultAnalyzer(){}return DefaultAnalyzer.prototype.getAcceptableSyntaxes=function(){return this._acceptableSyntaxes||(this._acceptableSyntaxes=this.constructAcceptableSyntaxes()),new AcceptableSyntaxes(this._acceptableSyntaxes)},DefaultAnalyzer.prototype.constructAcceptableSyntaxes=function(){var process=new AnalyzeProcess;for(var k in this)if("function"==typeof this[k]){var func=null;0===k.indexOf("block_")?func=this[k]:0===k.indexOf("inline_")?func=this[k]:"headline"===k?func=this[k]:"ulist"===k&&(func=this[k]),func&&(process.prepare(),func(process),process.build(k))}return process.acceptableSyntaxes},DefaultAnalyzer.prototype.headline=function(builder){builder.setSyntaxType(SyntaxType.Other),builder.setClass(ReVIEW.Parse.HeadlineSyntaxTree),builder.setDescription(t("description.headline")),builder.processNode(function(process,n){var node=n.toHeadline(),label=null;if(node.label)label=node.label.arg;else if(1===node.caption.childNodes.length){var textNode=node.caption.childNodes[0].toTextNode();label=textNode.text}process.addSymbol({symbolName:"hd",labelName:label,node:node})})},DefaultAnalyzer.prototype.ulist=function(builder){builder.setSyntaxType(SyntaxType.Other),builder.setClass(ReVIEW.Parse.UlistElementSyntaxTree),builder.setDescription(t("description.ulist")),builder.processNode(function(process,n){var node=n.toUlist();process.addSymbol({symbolName:"li",level:node.level,text:node.text,node:node})})},DefaultAnalyzer.prototype.block_list=function(builder){builder.setSyntaxType(SyntaxType.Block),builder.setSymbol("list"),builder.setDescription(t("description.block_list")),builder.checkArgsLength(2),builder.processNode(function(process,n){var node=n.toBlockElement();node.no=process.nextIndex("list"),process.addSymbol({symbolName:node.symbol,labelName:node.args[0].arg,node:node})})},DefaultAnalyzer.prototype.inline_list=function(builder){builder.setSyntaxType(SyntaxType.Inline),builder.setSymbol("list"),builder.setDescription(t("description.inline_list")),builder.processNode(function(process,n){var node=n.toInlineElement();process.addSymbol({symbolName:node.symbol,referenceTo:process.constructReferenceTo(node,ReVIEW.nodeContentToString(process,node)),node:node})})},DefaultAnalyzer.prototype.inline_hd=function(builder){builder.setSyntaxType(SyntaxType.Inline),builder.setSymbol("hd"),builder.setDescription(t("description.inline_hd")),builder.processNode(function(process,n){var node=n.toInlineElement();process.addSymbol({symbolName:node.symbol,referenceTo:process.constructReferenceTo(node,ReVIEW.nodeContentToString(process,node)),node:node})})},DefaultAnalyzer.prototype.inline_br=function(builder){builder.setSyntaxType(SyntaxType.Inline),builder.setSymbol("br"),builder.setDescription(t("description.inline_br")),builder.processNode(function(process,n){var node=n.toInlineElement();process.addSymbol({symbolName:node.symbol,node:node})})},DefaultAnalyzer.prototype.inline_b=function(builder){builder.setSyntaxType(SyntaxType.Inline),builder.setSymbol("b"),builder.setDescription(t("description.inline_b")),builder.processNode(function(process,n){var node=n.toInlineElement();process.addSymbol({symbolName:node.symbol,node:node})})},DefaultAnalyzer.prototype.inline_code=function(builder){builder.setSyntaxType(SyntaxType.Inline),builder.setSymbol("code"),builder.setDescription(t("description.inline_code")),builder.processNode(function(process,n){var node=n.toInlineElement();process.addSymbol({symbolName:node.symbol,node:node})})},DefaultAnalyzer.prototype.inline_tt=function(builder){builder.setSyntaxType(SyntaxType.Inline),builder.setSymbol("tt"),builder.setDescription(t("description.inline_tt")),builder.processNode(function(process,n){var node=n.toInlineElement();process.addSymbol({symbolName:node.symbol,node:node})})},DefaultAnalyzer.prototype.inline_href=function(builder){builder.setSyntaxType(SyntaxType.Inline),builder.setSymbol("href"),builder.setDescription(t("description.inline_href")),builder.processNode(function(process,n){var node=n.toInlineElement();process.addSymbol({symbolName:node.symbol,node:node})})},DefaultAnalyzer.prototype.inline_kw=function(builder){builder.setSyntaxType(SyntaxType.Inline),builder.setSymbol("kw"),builder.setDescription(t("description.inline_kw")),builder.processNode(function(process,n){var node=n.toInlineElement();process.addSymbol({symbolName:node.symbol,node:node})})},DefaultAnalyzer.prototype.inline_em=function(builder){builder.setSyntaxType(SyntaxType.Inline),builder.setSymbol("em"),builder.setDescription(t("description.inline_em")),builder.processNode(function(process,n){var node=n.toInlineElement();process.addSymbol({symbolName:node.symbol,node:node})})},DefaultAnalyzer}();Build.DefaultAnalyzer=DefaultAnalyzer}(ReVIEW.Build||(ReVIEW.Build={})),ReVIEW.Build}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){!function(Build){ReVIEW.Parse.SyntaxTree,ReVIEW.Parse.NodeSyntaxTree,ReVIEW.Parse.BlockElementSyntaxTree,ReVIEW.Parse.InlineElementSyntaxTree,ReVIEW.Parse.HeadlineSyntaxTree,ReVIEW.Parse.UlistElementSyntaxTree,ReVIEW.Parse.TextNodeSyntaxTree,ReVIEW.Parse.ChapterSyntaxTree;var DefaultBuilder=function(){function DefaultBuilder(){}return Object.defineProperty(DefaultBuilder.prototype,"name",{get:function(){return this.constructor.name},enumerable:!0,configurable:!0}),DefaultBuilder.prototype.init=function(book){var _this=this;this.book=book,book.parts.forEach(function(part){part.chapters.forEach(function(chapter){var process=chapter.createBuilderProcess(_this);ReVIEW.visit(chapter.root,{visitDefaultPre:function(){},visitChapterPre:function(node){return _this.chapterPre(process,node)},visitChapterPost:function(node){return _this.chapterPost(process,node)},visitHeadlinePre:function(node){return _this.headlinePre(process,"hd",node)},visitHeadlinePost:function(node){return _this.headlinePost(process,"hd",node)},visitUlistPre:function(node){return _this.ulistPre(process,"li",node)},visitUlistPost:function(node){return _this.ulistPost(process,"li",node)},visitBlockElementPre:function(node){return _this.blockPre(process,node.symbol,node)},visitBlockElementPost:function(node){return _this.blockPost(process,node.symbol,node)},visitInlineElementPre:function(node){return _this.inlinePre(process,node.symbol,node)},visitInlineElementPost:function(node){return _this.inlinePost(process,node.symbol,node)},visitTextPre:function(node){_this.text(process,node)}}),_this.processPost(process,chapter)})}),book.parts.forEach(function(part){part.chapters.forEach(function(chapter){chapter.process.doAfterProcess()})})},DefaultBuilder.prototype.processPost=function(){},DefaultBuilder.prototype.chapterPre=function(){},DefaultBuilder.prototype.chapterPost=function(){},DefaultBuilder.prototype.headlinePre=function(){},DefaultBuilder.prototype.headlinePost=function(){},DefaultBuilder.prototype.ulistPre=function(){},DefaultBuilder.prototype.ulistPost=function(){},DefaultBuilder.prototype.text=function(process,node){process.out(node.text)},DefaultBuilder.prototype.blockPre=function(process,name,node){var func;if(func=this["block_"+name],"function"==typeof func)return func.call(this,process,node);if(func=this["block_"+name+"_pre"],"function"!=typeof func)throw new Build.AnalyzerError("block_"+name+"_pre or block_"+name+" is not Function");return func.call(this,process,node)},DefaultBuilder.prototype.blockPost=function(process,name,node){var func;if(func=this["block_"+name],"function"!=typeof func){if(func=this["block_"+name+"_post"],"function"!=typeof func)throw new Build.AnalyzerError("block_"+name+"_post is not Function");return func.call(this,process,node)}},DefaultBuilder.prototype.inlinePre=function(process,name,node){var func;if(func=this["inline_"+name],"function"==typeof func)return func.call(this,process,node);if(func=this["inline_"+name+"_pre"],"function"!=typeof func)throw new Build.AnalyzerError("inline_"+name+"_pre or inline_"+name+" is not Function");return func.call(this,process,node)},DefaultBuilder.prototype.inlinePost=function(process,name,node){var func;if(func=this["inline_"+name],"function"!=typeof func){if(func=this["inline_"+name+"_post"],"function"!=typeof func)throw new Build.AnalyzerError("inline_"+name+"_post is not Function");return func.call(this,process,node)}},DefaultBuilder.prototype.findReference=function(process,node){var founds=process.symbols.filter(function(symbol){return symbol.node===node});if(1!==founds.length)throw new Build.AnalyzerError("invalid status.");return founds[0]},DefaultBuilder}();Build.DefaultBuilder=DefaultBuilder}(ReVIEW.Build||(ReVIEW.Build={})),ReVIEW.Build}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){var t=ReVIEW.i18n.t;!function(ReportLevel){ReportLevel[ReportLevel.Info=0]="Info",ReportLevel[ReportLevel.Warning=1]="Warning",ReportLevel[ReportLevel.Error=2]="Error"}(ReVIEW.ReportLevel||(ReVIEW.ReportLevel={}));var ReportLevel=ReVIEW.ReportLevel,ProcessReport=function(){function ProcessReport(level,part,chapter,message,nodes){"undefined"==typeof nodes&&(nodes=[]),this.level=level,this.part=part,this.chapter=chapter,this.message=message,this.nodes=nodes}return ProcessReport}();ReVIEW.ProcessReport=ProcessReport;var Process=function(){function Process(part,chapter,input){this.part=part,this.chapter=chapter,this.input=input,this.symbols=[],this.indexCounter={},this.afterProcess=[],this._reports=[]}return Process.prototype.info=function(message){for(var nodes=[],_i=0;_i<arguments.length-1;_i++)nodes[_i]=arguments[_i+1];this._reports.push(new ProcessReport(ReportLevel.Info,this.part,this.chapter,message,nodes))},Process.prototype.warn=function(message){for(var nodes=[],_i=0;_i<arguments.length-1;_i++)nodes[_i]=arguments[_i+1];this._reports.push(new ProcessReport(ReportLevel.Warning,this.part,this.chapter,message,nodes))},Process.prototype.error=function(message){for(var nodes=[],_i=0;_i<arguments.length-1;_i++)nodes[_i]=arguments[_i+1];this._reports.push(new ProcessReport(ReportLevel.Error,this.part,this.chapter,message,nodes))},Process.prototype.nextIndex=function(kind){var nextIndex=this.indexCounter[kind];return"undefined"==typeof nextIndex?nextIndex=1:nextIndex++,this.indexCounter[kind]=nextIndex,nextIndex},Object.defineProperty(Process.prototype,"reports",{get:function(){return this._reports.sort(function(a,b){return 0===a.nodes.length&&0===b.nodes.length?0:0===a.nodes.length?-1:0===b.nodes.length?1:a.nodes[0].offset-b.nodes[0].offset})},enumerable:!0,configurable:!0}),Process.prototype.addSymbol=function(symbol){symbol.part=this.part,symbol.chapter=this.chapter,this.symbols.push(symbol)},Object.defineProperty(Process.prototype,"missingSymbols",{get:function(){var result=[];return this.symbols.forEach(function(symbol){symbol.referenceTo&&!symbol.referenceTo.referenceNode&&result.push(symbol)}),result},enumerable:!0,configurable:!0}),Process.prototype.constructReferenceTo=function(node,value,targetSymbol,separator){"undefined"==typeof targetSymbol&&(targetSymbol=node.symbol),"undefined"==typeof separator&&(separator="|");var splitted=value.split(separator);if(3===splitted.length)return{partName:splitted[0],chapterName:splitted[1],targetSymbol:targetSymbol,label:splitted[2]};if(2===splitted.length)return{part:this.part,partName:this.part.name,chapterName:splitted[0],targetSymbol:targetSymbol,label:splitted[1]};if(1===splitted.length)return{part:this.part,partName:this.part.name,chapter:this.chapter,chapterName:this.chapter.name,targetSymbol:targetSymbol,label:splitted[0]};var message=t("compile.args_length_mismatch","1 or 2 or 3",splitted.length);return this.error(message,node),null},Process.prototype.addAfterProcess=function(func){this.afterProcess.push(func)},Process.prototype.doAfterProcess=function(){this.afterProcess.forEach(function(func){return func()}),this.afterProcess=[]},Process}();ReVIEW.Process=Process;var BuilderProcess=function(){function BuilderProcess(builder,base){this.builder=builder,this.base=base,this.result=""}return Object.defineProperty(BuilderProcess.prototype,"info",{get:function(){return this.base.info},enumerable:!0,configurable:!0}),Object.defineProperty(BuilderProcess.prototype,"warn",{get:function(){return this.base.warn},enumerable:!0,configurable:!0}),Object.defineProperty(BuilderProcess.prototype,"error",{get:function(){return this.base.error},enumerable:!0,configurable:!0}),BuilderProcess.prototype.out=function(data){return this.result+=data,this},BuilderProcess.prototype.pushOut=function(data){return this.result=data+this.result,this},Object.defineProperty(BuilderProcess.prototype,"input",{get:function(){return this.base.input
},enumerable:!0,configurable:!0}),Object.defineProperty(BuilderProcess.prototype,"symbols",{get:function(){return this.base.symbols},enumerable:!0,configurable:!0}),BuilderProcess}();ReVIEW.BuilderProcess=BuilderProcess;var Book=function(){function Book(config){this.config=config,this.parts=[]}return Object.defineProperty(Book.prototype,"reports",{get:function(){var flatten=function(data){return data.some(function(d){return Array.isArray(d)})?flatten(data.reduce(function(p,c){return p.concat(c)},[])):data};return flatten(this.parts.map(function(part){return part.chapters.map(function(chapter){return chapter.process.reports})}))},enumerable:!0,configurable:!0}),Book}();ReVIEW.Book=Book;var Part=function(){function Part(parent,no,name){this.parent=parent,this.no=no,this.name=name}return Part}();ReVIEW.Part=Part;var Chapter=function(){function Chapter(parent,no,name,input,root){this.parent=parent,this.no=no,this.name=name,this.input=input,this.root=root,this.builderProcesses=[],this.process=new Process(this.parent,this,input)}return Chapter.prototype.createBuilderProcess=function(builder){var builderProcess=new BuilderProcess(builder,this.process);return this.builderProcesses.push(builderProcess),builderProcess},Chapter.prototype.findResultByBuilder=function(builder){var founds;return founds="string"==typeof builder?this.builderProcesses.filter(function(process){return process.builder.name===builder}):this.builderProcesses.filter(function(process){return process.builder===builder}),founds[0].result},Chapter}();ReVIEW.Chapter=Chapter}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){var t=ReVIEW.i18n.t,SyntaxTree=ReVIEW.Parse.SyntaxTree;ReVIEW.Parse.HeadlineSyntaxTree,ReVIEW.Parse.BlockElementSyntaxTree,ReVIEW.Parse.InlineElementSyntaxTree,ReVIEW.Parse.TextNodeSyntaxTree,ReVIEW.Parse.ChapterSyntaxTree;var flatten=ReVIEW.flatten,Controller=function(){function Controller(options){"undefined"==typeof options&&(options={}),this.options=options}return Controller.prototype.initConfig=function(data){this.config=data,data.analyzer=data.analyzer||new ReVIEW.Build.DefaultAnalyzer,data.validators&&0!==data.validators.length?Array.isArray(data.validators)||(this.config.validators=[data.validators]):this.config.validators=[new ReVIEW.Build.DefaultValidator],data.builders&&0!==data.builders.length?Array.isArray(data.builders)||(this.config.builders=[data.builders]):this.config.builders=[new ReVIEW.Build.DefaultBuilder]},Controller.prototype.process=function(){var _this=this,acceptableSyntaxes=this.config.analyzer.getAcceptableSyntaxes();if(this.config.listener&&this.config.listener.onAcceptables&&this.config.listener.onAcceptables(acceptableSyntaxes)===!1)return null;var book=this.processBook();if(this.config.validators.forEach(function(validator){validator.start(book,acceptableSyntaxes,_this.config.builders)}),book.reports.some(function(report){return report.level===ReVIEW.ReportLevel.Error}))return this.outputReport(book.reports),book;if(this.config.listener&&this.config.listener.onSymbols){var symbols=flatten(book.parts.map(function(part){return part.chapters.map(function(chapter){return chapter.process.symbols})}));if(this.config.listener.onSymbols(symbols)===!1)return null}return this.config.builders.forEach(function(builder){builder.init(book)}),this.outputReport(book.reports),this.compileFinished(book),book},Controller.prototype.processBook=function(){var _this=this,book=new ReVIEW.Book(this.config);return book.parts=Object.keys(this.config.book).map(function(key,index){var chapters=_this.config.book[key];return _this.processPart(book,index,key,chapters)}),book.parts.forEach(function(part){var chapters=[];part.chapters.forEach(function(chapter){ReVIEW.visit(chapter.root,{visitDefaultPre:function(){},visitChapterPre:function(node){chapters.push(node)}})});var counter={},max=0,currentLevel=0;chapters.forEach(function(chapter){var level=chapter.headline.level;if(max=Math.max(max,level),currentLevel>level)for(var i=level+1;max>=i;i++)counter[i]=0;else if(level>currentLevel)for(var i=level;max>=i;i++)counter[i]=0;currentLevel=level,counter[level]+=1,chapter.no=counter[level]})}),book},Controller.prototype.processPart=function(book,index,name,chapters){"undefined"==typeof chapters&&(chapters=[]);var _this=this,part=new ReVIEW.Part(book,index+1,name);return part.chapters=chapters.map(function(chapter,index){return _this.processChapter(book,part,index,chapter)}),part},Controller.prototype.processChapter=function(book,part,index,chapterPath){var resolvedPath=this.resolvePath(chapterPath),data=this.read(resolvedPath);if(!data){var chapter=new ReVIEW.Chapter(part,index+1,chapterPath,data,null);return chapter.process.error(t("compile.file_not_exists",resolvedPath)),chapter}try{var parseResult=ReVIEW.Parse.parse(data),chapter=new ReVIEW.Chapter(part,index+1,chapterPath,data,parseResult.ast)}catch(e){if(!(e instanceof PEG.SyntaxError))throw e;var se=e,errorNode=new SyntaxTree({syntax:se.name,line:se.line,column:se.column,offset:se.offset,endPos:-1}),chapter=new ReVIEW.Chapter(part,index+1,chapterPath,data,null);chapter.process.error(se.message,errorNode)}return chapter},Object.defineProperty(Controller.prototype,"read",{get:function(){return this.config.read||ReVIEW.IO.read},enumerable:!0,configurable:!0}),Object.defineProperty(Controller.prototype,"write",{get:function(){return this.config.write||ReVIEW.IO.write},enumerable:!0,configurable:!0}),Object.defineProperty(Controller.prototype,"outputReport",{get:function(){return this.config.listener&&this.config.listener.onReports?this.config.listener.onReports:ReVIEW.isNodeJS()?this.outputReportNodeJS:this.outputReportBrowser},enumerable:!0,configurable:!0}),Controller.prototype.outputReportNodeJS=function(reports){var colors=require("colors");colors.setTheme({info:"cyan",warn:"yellow",error:"red"}),reports.forEach(function(report){var message="";if(message+=report.chapter.name+" ",report.nodes.forEach(function(node){message+="["+node.line+","+node.column+"] "}),message+=report.message,report.level===ReVIEW.ReportLevel.Error)console.warn(message.error);else if(report.level===ReVIEW.ReportLevel.Warning)console.error(message.warn);else{if(report.level!==ReVIEW.ReportLevel.Info)throw new Error("unknown report level.");console.info(message.info)}})},Controller.prototype.outputReportBrowser=function(reports){reports.forEach(function(report){var message="";if(message+=report.chapter.name+" ",report.nodes.forEach(function(node){message+="["+node.line+","+node.column+"] "}),message+=report.message,report.level===ReVIEW.ReportLevel.Error)console.warn(message);else if(report.level===ReVIEW.ReportLevel.Warning)console.error(message);else{if(report.level!==ReVIEW.ReportLevel.Info)throw new Error("unknown report level.");console.info(message)}})},Controller.prototype.compileFinished=function(book){var func=function(){};book.reports.some(function(report){return report.level===ReVIEW.ReportLevel.Error})?this.config.listener&&this.config.listener.onCompileFailed?func=this.config.listener.onCompileFailed:ReVIEW.isNodeJS()&&(func=function(){process.exit(1)}):this.config.listener&&this.config.listener.onCompileSuccess?func=this.config.listener.onCompileSuccess:ReVIEW.isNodeJS()&&(func=function(){process.exit(0)}),func(book)},Controller.prototype.resolvePath=function(path){if(ReVIEW.isNodeJS()){var p=require("path"),base=this.options.base||"./";return p.join(base,path)}return this.options.base?(this.endWith(base,"/")||this.startWith(path,"/")||(base+="/"),base+path):path},Controller.prototype.startWith=function(str,target){return 0===str.indexOf(target)},Controller.prototype.endWith=function(str,target){return-1!==str.indexOf(target,str.length-target.length)},Controller}();ReVIEW.Controller=Controller}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){!function(Build){var t=ReVIEW.i18n.t;ReVIEW.Parse.SyntaxTree,ReVIEW.Parse.ChapterSyntaxTree,ReVIEW.Parse.HeadlineSyntaxTree,ReVIEW.Parse.BlockElementSyntaxTree,ReVIEW.Parse.InlineElementSyntaxTree;var DefaultValidator=function(){function DefaultValidator(){}return DefaultValidator.prototype.start=function(book,acceptableSyntaxes,builders){this.acceptableSyntaxes=acceptableSyntaxes,this.builders=builders,this.checkBook(book),this.resolveSymbolAndReference(book)},DefaultValidator.prototype.checkBook=function(book){var _this=this;book.parts.forEach(function(part){return _this.checkPart(part)})},DefaultValidator.prototype.checkPart=function(part){var _this=this;part.chapters.forEach(function(chapter){return _this.checkChapter(chapter)})},DefaultValidator.prototype.checkChapter=function(chapter){var _this=this;ReVIEW.visit(chapter.root,{visitDefaultPre:function(){},visitHeadlinePre:function(node){var results=_this.acceptableSyntaxes.find(node);return 1!==results.length?(chapter.process.error(t("compile.syntax_definietion_error"),node),void 0):results[0].process(chapter.process,node)},visitBlockElementPre:function(node){var results=_this.acceptableSyntaxes.find(node);if(1!==results.length)return chapter.process.error(t("compile.syntax_definietion_error"),node),void 0;var expects=results[0].argsLength,arg=node.args||[];if(-1===expects.indexOf(arg.length)){var expected=expects.map(function(n){return Number(n).toString()}).join(" or "),message=t("compile.args_length_mismatch",expected,arg.length);return chapter.process.error(message,node),void 0}return results[0].process(chapter.process,node)},visitInlineElementPre:function(node){var results=_this.acceptableSyntaxes.find(node);return 1!==results.length?(chapter.process.error(t("compile.syntax_definietion_error"),node),void 0):results[0].process(chapter.process,node)}}),ReVIEW.visit(chapter.root,{visitDefaultPre:function(){},visitChapterPre:function(node){if(1===node.level)ReVIEW.findChapter(node)||chapter.process.error(t("compile.chapter_not_toplevel"),node);else{var parent=ReVIEW.findChapter(node.parentNode);parent?parent.level!==node.level-1&&chapter.process.error(t("compile.chapter_level_omission",node.level,node.level-1,parent?String(parent.level):"none"),node):chapter.process.error(t("compile.chapter_topleve_eq1"),node)}}})},DefaultValidator.prototype.resolveSymbolAndReference=function(book){var symbols=ReVIEW.flatten(book.parts.map(function(part){return part.chapters.map(function(chapter){return chapter.process.symbols})}));symbols.forEach(function(symbol){var referenceTo=symbol.referenceTo;if(referenceTo)return referenceTo.part||book.parts.forEach(function(part){referenceTo.partName===part.name&&(referenceTo.part=part)}),referenceTo.part?(referenceTo.chapter||referenceTo.part.chapters.forEach(function(chap){referenceTo.chapterName===chap.name&&(referenceTo.chapter=chap)}),referenceTo.chapter?void 0:(symbol.chapter.process.error(t("compile.chapter_is_missing",symbol.chapter.name),symbol.node),void 0)):(symbol.chapter.process.error(t("compile.part_is_missing",symbol.part.name),symbol.node),void 0)}),symbols.forEach(function(symbol){if(symbol.referenceTo&&!symbol.referenceTo.referenceNode){var reference=symbol.referenceTo;if(symbols.forEach(function(symbol){reference.part===symbol.part&&reference.chapter===symbol.chapter&&reference.targetSymbol===symbol.symbolName&&reference.label===symbol.labelName&&(reference.referenceNode=symbol.node)}),!reference.referenceNode)return symbol.chapter.process.error(t("compile.reference_is_missing",reference.targetSymbol,reference.label),symbol.node),void 0}}),symbols.forEach(function(symbol1){symbols.forEach(function(symbol2){return symbol1!==symbol2?symbol1.chapter===symbol2.chapter&&symbol1.symbolName===symbol2.symbolName&&symbol1.labelName&&symbol2.labelName&&symbol1.labelName===symbol2.labelName?(symbol1.chapter.process.error(t("compile.duplicated_label"),symbol1.node,symbol2.node),void 0):void 0:void 0})})},DefaultValidator}();Build.DefaultValidator=DefaultValidator}(ReVIEW.Build||(ReVIEW.Build={})),ReVIEW.Build}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){!function(Build){var i18n=ReVIEW.i18n;ReVIEW.Parse.SyntaxTree,ReVIEW.Parse.NodeSyntaxTree,ReVIEW.Parse.BlockElementSyntaxTree,ReVIEW.Parse.InlineElementSyntaxTree,ReVIEW.Parse.HeadlineSyntaxTree,ReVIEW.Parse.UlistElementSyntaxTree,ReVIEW.Parse.TextNodeSyntaxTree,ReVIEW.Parse.ChapterSyntaxTree;var nodeContentToString=ReVIEW.nodeContentToString,findChapter=ReVIEW.findChapter,TextBuilder=function(_super){function TextBuilder(){_super.apply(this,arguments)}return __extends(TextBuilder,_super),TextBuilder.prototype.chapterPost=function(process,node){node.headline.cmd?process.out("◆→終了:←◆\n"):process.out("\n")},TextBuilder.prototype.headlinePre=function(process,name,node){if(node.cmd)return process.out("◆→開始:←◆\n"),process.out("■"),function(v){ReVIEW.visit(node.caption,v)};if(process.out("■H").out(node.level).out("■"),1===node.level){var text=i18n.t("builder.chapter",node.parentNode.no);process.out(text).out("　")}else 2===node.level&&process.out(node.parentNode.toChapter().fqn).out("　")},TextBuilder.prototype.headlinePost=function(process){process.out("\n\n")},TextBuilder.prototype.ulistPre=function(process,name,node){return process.out("・"),function(v){ReVIEW.visit(node.text,v),process.out("\n"),node.childNodes.forEach(function(child){process.out(ReVIEW.stringRepeat(child.toUlist().level-1,"    ")),ReVIEW.visit(child,v)})}},TextBuilder.prototype.ulistPost=function(){},TextBuilder.prototype.block_list_pre=function(process,node){process.out("◆→開始:リスト←◆\n");var chapter=findChapter(node,1),text=i18n.t("builder.list",chapter.fqn,node.no);return process.out(text).out("　").out(node.args[1].arg).out("\n\n"),function(v){node.childNodes.forEach(function(node){ReVIEW.visit(node,v)})}},TextBuilder.prototype.block_list_post=function(process){process.out("◆→終了:リスト←◆\n")},TextBuilder.prototype.inline_list=function(process,node){var chapter=findChapter(node,1),listNode=this.findReference(process,node).referenceTo.referenceNode.toBlockElement(),text=i18n.t("builder.list",chapter.fqn,listNode.no);return process.out(text),!1},TextBuilder.prototype.inline_hd_pre=function(process,node){process.out("「");var chapter=findChapter(node);return 1===chapter.level?process.out(chapter.fqn).out("章 "):process.out(chapter.fqn).out(" "),process.out(nodeContentToString(process,chapter.headline)),!1},TextBuilder.prototype.inline_hd_post=function(process){process.out("」")},TextBuilder.prototype.inline_br=function(process){process.out("\n")},TextBuilder.prototype.inline_b_pre=function(process){process.out("★")},TextBuilder.prototype.inline_b_post=function(process){process.out("☆")},TextBuilder.prototype.inline_code_pre=function(process){process.out("△")},TextBuilder.prototype.inline_code_post=function(process){process.out("☆")},TextBuilder.prototype.inline_href_pre=function(process){process.out("△")},TextBuilder.prototype.inline_href_post=function(process){process.out("☆")},TextBuilder.prototype.inline_kw=function(process){process.out("[p]")},TextBuilder.prototype.inline_tt_pre=function(process){process.out("△")},TextBuilder.prototype.inline_tt_post=function(process){process.out("☆")},TextBuilder}(Build.DefaultBuilder);Build.TextBuilder=TextBuilder}(ReVIEW.Build||(ReVIEW.Build={})),ReVIEW.Build}(ReVIEW||(ReVIEW={}));var ReVIEW;!function(ReVIEW){!function(Build){var i18n=ReVIEW.i18n;ReVIEW.Parse.SyntaxTree,ReVIEW.Parse.NodeSyntaxTree;var BlockElementSyntaxTree=ReVIEW.Parse.BlockElementSyntaxTree;ReVIEW.Parse.InlineElementSyntaxTree;var HeadlineSyntaxTree=ReVIEW.Parse.HeadlineSyntaxTree;ReVIEW.Parse.UlistElementSyntaxTree,ReVIEW.Parse.TextNodeSyntaxTree,ReVIEW.Parse.ChapterSyntaxTree;var nodeContentToString=ReVIEW.nodeContentToString,findChapter=ReVIEW.findChapter,HtmlBuilder=function(_super){function HtmlBuilder(standalone){"undefined"==typeof standalone&&(standalone=!0),_super.call(this),this.standalone=standalone}return __extends(HtmlBuilder,_super),HtmlBuilder.prototype.processPost=function(process,chapter){if(this.standalone){var pre="";pre+='<?xml version="1.0" encoding="UTF-8"?>\n',pre+='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">\n',pre+='<html xmlns="http://www.w3.org/1999/xhtml" xmlns:ops="http://www.idpf.org/2007/ops" xml:lang="ja">\n',pre+="<head>\n",pre+='  <meta http-equiv="Content-Type" content="text/html;charset=UTF-8" />\n',pre+='  <meta http-equiv="Content-Style-Type" content="text/css" />\n',pre+='  <meta name="generator" content="ReVIEW" />\n';var name=null;ReVIEW.visit(chapter.root,{visitDefaultPre:function(){},visitChapterPre:function(node){name=nodeContentToString(process,node.headline.caption)}}),pre+="  <title>"+name+"</title>\n",pre+="</head>\n",pre+="<body>\n",process.pushOut(pre),process.out("</body>\n"),process.out("</html>\n")}},HtmlBuilder.prototype.text=function(process,node){var plane=!1;ReVIEW.walk(node,function(node){if(!node.parentNode)return null;if(node instanceof BlockElementSyntaxTree){var block=node.toBlockElement();if("list"===block.symbol)return plane=!0,null}else if(node instanceof HeadlineSyntaxTree)return plane=!0,null;return node.parentNode}),plane?process.out(node.text):(process.out("<p>"),process.out(node.text),process.out("</p>\n"))},HtmlBuilder.prototype.headlinePre=function(process,name,node){if(node.cmd&&process.out('<div class="column">\n'),process.out("<h").out(node.level),node.label&&process.out(' id="').out(node.label.arg).out('"'),process.out(">"),node.cmd?process.out('<a id="column-').out(node.parentNode.no).out('"></a>'):process.out('<a id="h').out(node.level).out('"></a>'),node.cmd)return function(v){ReVIEW.visit(node.caption,v)};if(1===node.level){var text=i18n.t("builder.chapter",node.parentNode.no);process.out(text).out("　")}else 2===node.level&&process.out(node.parentNode.toChapter().fqn).out("　")},HtmlBuilder.prototype.headlinePost=function(process,name,node){process.out("</h").out(node.level).out(">\n"),node.cmd&&process.out("</div>\n")},HtmlBuilder.prototype.ulistPre=function(process,name,node){return process.out("<li>"),node.childNodes.length>0?function(v){ReVIEW.visit(node.text,v),process.out("<ul>"),node.childNodes.forEach(function(child){ReVIEW.visit(child,v)}),process.out("</ul>")}:void 0},HtmlBuilder.prototype.ulistPost=function(process){process.out("</li>")},HtmlBuilder.prototype.block_list_pre=function(process,node){process.out('<div class="caption-code">\n');var chapter=findChapter(node,1),text=i18n.t("builder.list",chapter.fqn,node.no);return process.out('<p class="caption">').out(text).out(": ").out(node.args[1].arg).out("</p>\n"),process.out('<pre class="list">'),function(v){node.childNodes.forEach(function(node){ReVIEW.visit(node,v)})}},HtmlBuilder.prototype.block_list_post=function(process){process.out("</pre>\n").out("</div>\n")},HtmlBuilder.prototype.inline_list=function(process,node){var chapter=findChapter(node,1),listNode=this.findReference(process,node).referenceTo.referenceNode.toBlockElement(),text=i18n.t("builder.list",chapter.fqn,listNode.no);return process.out(text),!1},HtmlBuilder.prototype.inline_hd_pre=function(process,node){process.out("「");var chapter=findChapter(node);return 1===chapter.level?process.out(chapter.fqn).out("章 "):process.out(chapter.fqn).out(" "),process.out(nodeContentToString(process,chapter.headline)),!1},HtmlBuilder.prototype.inline_hd_post=function(process){process.out("」")},HtmlBuilder.prototype.inline_br=function(process){process.out("<br/>")},HtmlBuilder.prototype.inline_b_pre=function(process){process.out("<b>")},HtmlBuilder.prototype.inline_b_post=function(process){process.out("</b>")},HtmlBuilder.prototype.inline_code_pre=function(process){process.out("<tt class='inline-code'>")},HtmlBuilder.prototype.inline_code_post=function(process){process.out("</tt>")},HtmlBuilder.prototype.inline_href_pre=function(process,node){var href=nodeContentToString(process,node);process.out('<a href="'+href+'">')},HtmlBuilder.prototype.inline_href_post=function(process){process.out("</a>")},HtmlBuilder.prototype.inline_tt_pre=function(process){process.out("<tt>")},HtmlBuilder.prototype.inline_tt_post=function(process){process.out("</tt>")},HtmlBuilder.prototype.inline_kw_pre=function(process,node){return process.out("<b>"),process.out(ReVIEW.nodeToString(process,node)),!1},HtmlBuilder.prototype.inline_em_pre=function(process){process.out("<em>")},HtmlBuilder.prototype.inline_em_post=function(process){process.out("</em>")},HtmlBuilder}(Build.DefaultBuilder);Build.HtmlBuilder=HtmlBuilder}(ReVIEW.Build||(ReVIEW.Build={})),ReVIEW.Build}(ReVIEW||(ReVIEW={}));var ReVIEW;if(function(ReVIEW){function start(setup,options){var controller=new ReVIEW.Controller(options);return setup(controller),controller.process()}ReVIEW.start=start}(ReVIEW||(ReVIEW={})),ReVIEW.isNodeJS()&&(module.exports=ReVIEW),ReVIEW.isNodeJS()){var program=require("commander");program.version("TODO","-v, --version").option("--reviewfile <file>","where is ReVIEWconfig.js?").option("--base <path>","alternative base path"),program.command("compile <document>").description("compile ReVIEW document").option("--ast","output JSON format abstract syntax tree").option("-t, --target <target>","output format of document").action(function(document,options){options.ast||!1}),program.command("*").action(function(){var reviewfile=program.reviewfile||"./ReVIEWconfig",setup=require(reviewfile);ReVIEW.start(setup,{reviewfile:reviewfile,base:program.base})});var endWith=function(str,target){return-1!==str.indexOf(target,str.length-target.length)};endWith(process.argv[1],"review.js")&&program.parse(process.argv)}
